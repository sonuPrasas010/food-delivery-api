...
var gvjs_mla = { gBa: gvjs_yd, HAa: gvjs_bd, TEXT: gvjs_m, YF: gvjs_ub },
    gvjs_nla = { IM: gvjs_S, MM: gvjs_U },
    gvjs_ola = [
        "AD",
        "AE",
        "AF",
    ...
    if (null != a) {
        ...
        if (null != b.pb("elaborated")) {
            ...
            null != a &&
                ...
                null != b &&
                null != c &&
                (this.Nj = { oj: a, gJ: c, origin: { x: d, y: b } });
        }
    }
}
...
function gvjs_FZ(a) {
    ...
    Object.assign(b, a);
    b.origin = c;
    b.parallels && 0 !== b.parallels.length
        ? 2 > b.parallels.length &&
          (b.parallels[1] =
              Math.abs(b.parallels[0] - d[0]) > Math.abs(b.parallels[0] - d[1])
                  ? d[0]
                  : d[1])
        : (b.parallels = d);
    this.m = a || {};
...
gvjs_FZ.prototype.project = function (a) {
    ...
    return gvjs_v(arguments, function (c) {
        var d = c[0] / (180 / Math.PI),
            e = 0.5 * (Math.sin(b.bp[0]) + Math.sin(b.bp[1]));
        ...
        return {
            ...
            y:
                (180 / Math.PI) *
                (Math.sqrt(f - 2 * e * Math.sin(b.V1)) / e - d * Math.cos(c)),
        };
    });
};
function gvjs_GZ(a) {
...
gvjs_GZ.prototype.project = function (a) {
    return gvjs_v(arguments, function (b) {
        ...
        return {
            x:
                (((b[1] / (180 / Math.PI)) * 3) / (2 * Math.PI)) *
                Math.sqrt((Math.PI * Math.PI) / 3 - c * c) *
                (180 / Math.PI),
            y: c,
        };
    });
...
gvjs_HZ.prototype.project = function (a) {
    ...
    return gvjs_v(arguments, function (c) {
        var d = c[1] / (180 / Math.PI),
            e =
                Math.log((1 / Math.cos(b.bp[1])) * Math.cos(b.bp[0])) /
                Math.log(
                    (1 / Math.tan(0.25 * Math.PI + 0.5 * b.bp[0])) *
                        Math.tan(0.25 * Math.PI + 0.5 * b.bp[1])
                ),
            f =
                (Math.cos(b.bp[0]) *
                    Math.pow(Math.tan(0.25 * Math.PI + 0.5 * b.bp[0]), e)) /
                e;
        c =
            f *
            Math.pow(
                1 / Math.tan(0.25 * Math.PI + (c[0] / (180 / Math.PI)) * 0.5),
                e
            );
        return {
            x: (180 / Math.PI) * Math.sin(e * (d - b.$R)) * c,
            y:
                f * Math.pow(1 / Math.tan(0.25 * Math.PI + 0.5 * b.V1), e) -
                (180 / Math.PI) * Math.cos(e * (d - b.$R)) * c,
        };
    });
};
function gvjs_IZ(a) {
    return (
        (180 / Math.PI) *
        (Math.atan(Math.exp(a / (180 / Math.PI))) - Math.PI / 4) *
        2
    );
}
function gvjs_JZ() {
    ...
    gvjs_u(arguments, function (c) {
        for (var d in c)
            if (c.hasOwnProperty(d)) {
                d in b.Ir || (b.Ir[d] = { min: Infinity, max: -Infinity });
...
gvjs_JZ.prototype.getBounds = function (a) {
    return { min: this.Ir[a].min, max: this.Ir[a].max };
};
function gvjs_KZ(a) {
    this.m = a || {};
}
...
gvjs_KZ.prototype.project = function (a) {
    return gvjs_v(arguments, function (b) {
        return {
            ...
            y:
                (180 / Math.PI) *
                Math.log(Math.tan((b[0] / 180) * 0.5 * Math.PI + Math.PI / 4)),
        };
    });
};
var gvjs_rla = { sza: "albers", yAa: gvjs_sZ, BAa: "lambert", MAa: gvjs_yZ },
    gvjs_LZ = {};
...
var gvjs_sla = {
    ...
    gvjs_tla = { NONE: gvjs_f, fBa: gvjs_xT, Gza: "bounds", HM: gvjs_ut };
function gvjs_ula(a) {
    return gvjs_my(a, "projection", { name: gvjs_yZ }, function (b) {
        b = typeof b === gvjs_l ? b : (gvjs_lj(b) || {}).name;
        b = gvjs_Hj(b, gvjs_rla);
        if (!b)
            throw Error(
                'The projection you specified, "' + b + '", is not valid.'
            );
        return { name: b };
    });
}
var gvjs_MZ = {
    ...
    backgroundColor: { fill: gvjs_Ox, stroke: "#666", strokeWidth: 0 },
    ...
    tooltip: {
        isHtml: !1,
        textStyle: { fontName: gvjs_2r, fontSize: 13, color: gvjs_rt },
        trigger: gvjs_xu,
        showDisputedText: !1,
        showTitle: !0,
    },
    colorAxis: { minValue: null, maxValue: null, values: null },
    sizeAxis: { minValue: null, maxValue: null, minSize: 3, maxSize: 12 },
    legend: {
        position: gvjs_lZ,
        orientation: gvjs_S,
        textStyle: { color: gvjs_rt, auraColor: gvjs_Ox },
    },
    marker: { style: { stroke: { color: gvjs_yr, width: 1 } } },
    projection: gvjs_yZ,
    keepAspectRatio: !0,
    magnifyingGlass: { enable: !0, zoomFactor: 5 },
};
function gvjs_NZ(a) {
    gvjs_F.call(this);
    this.Sd = a;
    ...
    this.er = new gvjs_LT();
    this.isa =
        /^([a-zA-Z][a-zA-Z]|[a-zA-Z][a-zA-Z]\-[a-zA-Z0-9](|[a-zA-Z0-9](|[a-zA-Z0-9]))|\d\d\d)$/;
    this.psa = /^\d\d\d$/;
}
...
function gvjs_wla(a, b, c, d, e) {
    ...
    "metros" == d.resolution ||
    "continents" == d.resolution ||
    "subcontinents" == d.resolution
        ? a.oX(d, f, e)
        : a.rX(d, f, e);
}
...
gvjs_.rX = function (a, b, c) {
    ...
    gvjs_RT(f, function (h) {
        ...
        for (var k = [], l = 0; l < b.length; l++)
            if (null == h[l]) {
                var m = b[l];
                k.push({ address: m, Fea: l, Aca: null });
                h[l] = m;
            }
...
gvjs_.pX = function (a, b, c, d) {
    ...
    for (var f = 0; f < a.ca(); f++) {
        ...
        gvjs_QZ(this, c) && (g += " " + c);
        e.push({ address: g, Aca: f, Fea: null });
    }
    gvjs_OZ(this, e, c, d, []);
};
function gvjs_QZ(a, b) {
    return b == gvjs_CT || gvjs_Yy(b)
        ? !1
        : a.nI === gvjs_xT || a.nI === gvjs_ut;
}
function gvjs_xla(a) {
    var b = Infinity,
        c = Infinity,
    ...
    if (null != a.aF && 0 !== a.aF.views.length)
        return (
            ...
            { lo: { lat: b, lng: c }, hi: { lat: d, lng: e } }
        );
}
function gvjs_OZ(a, b, c, d, e) {
    for (var f = [], g = [], h = 0; h < b.length; h++) {
        var k = { address: b[h].address };
...
gvjs_.XZ = function (a, b, c, d, e) {
    for (var f = e.length, g = 0; g < f; g++) {
        ...
        if (e[g] && e[g][0]) {
            ...
            null != l &&
                ((c[l] = gvjs_yla(m)),
                c[l] || (gvjs_PZ(this, gvjs_iZ + k + '"'), (c[l] = k)));
            null != h &&
                (d[h] = {
...
function gvjs_yla(a) {
    ...
    b = b.short_name;
    "US" == b &&
        (a = gvjs_Yx(a.address_components, function (c) {
...
function gvjs_SZ(a, b) {
    ...
    for (var k = 0; k < b.views.length; ++k)
        gvjs_UZ(a, h, b, b.views[k], !1), gvjs_VZ(a, b, b.views[k]);
    a.mw = g.Sa();
    ...
    f = c.ZG(
        f,
        a.cw() ? new gvjs_5(g.left, g.top, g.width - 1, g.height - 1) : g
    );
    a.Xu = c.Sa();
    gvjs_XZ(a, b);
    a.jw = c.Sa();
...
function gvjs__Z(a, b, c) {
    ...
    if (c || !gvjs_Uz(a.pD.NC, b.NC))
        for (a.Vs && a.F.qc(a.Vs), c = 0; c < b.views.length; ++c)
...
function gvjs_YZ(a, b) {
    ...
    if (c) {
        var d = a.jw,
            ...
            m = c.Bca.x,
            n = c.Bca.y,
            p = new gvjs_3({ fill: "808080", fillOpacity: 0.25 }),
            q = new gvjs_SA();
        q.move(m, n);
        q.va(m, n + (h > n ? l : -l));
        q.va(m + (g > m ? k : -k), n);
        ...
        m = new gvjs_3({ fill: gvjs_Ox });
        m = e.Gl(g, h, k, l, m, d);
        gvjs_3Z(a, m, gvjs_tZ, !0);
        m = new gvjs_3({ stroke: "bfbfbf", strokeWidth: 1.5 });
        m = e.Gl(g, h, k, l, m, d);
        gvjs_3Z(a, m, gvjs_tZ, !0);
        m = e.Sa();
        f = e.ZG(
            m,
            new gvjs_5(f.left + 3.5, f.top + 3.5, f.width - 7, f.height - 7),
            !0
        );
        e.appendChild(d, f);
        f = new gvjs_3({ stroke: "cccccc", strokeWidth: 1.5 });
    ...
    a.VA =
        0 < b.qu.length
            ? gvjs_v(
                  ...
                  function (c) {
                      return c.html
                          ? gvjs_IG(c, this.Hi.getContainer())
                          : gvjs_JG(c, this.F, this.Xv).j();
                  },
                  a
              )
            : [];
...
function gvjs_5Z(a, b, c, d) {
    b = [c, b].join(".");
    b = a.Fd[b];
    if (null != b) for (c = 0; c < b.length; ++c) a.F.rj(b[c], d);
}
function gvjs_zla(a, b) {
    function c(e) {
        ...
        if (f && f.QO) {
            ...
            f.xb = gvjs_qB(e);
            a.nc.dispatchEvent({ type: g, elementType: h, data: f });
        }
    }
    var d = a.F;
    d.ic(b, gvjs_jd, c);
...
function gvjs_UZ(a, b, c, d, e) {
    for (var f = a.F.Sa(), g = 0; g < d.features.length; ++g) {
        ...
        0 != k.Rm.length &&
            (gvjs_1Z(h, f, k, !0, l, [m.Rm], "disputed"),
...
function gvjs_Gla(a, b) {
    ...
    c = gvjs_cz(
        new gvjs_z(c.x, c.y),
        new gvjs_z(a.left + a.width / 2, a.top + a.height / 2)
    );
    a = gvjs_BZ(a.Tb()) / 2;
    return c < 0.9 * a;
}
...
gvjs_9Z.prototype.YZ = function (a, b) {
    ...
    if (a.data.Ro) {
        ...
        this.mK = setTimeout(function () {
            c.mK = null;
            c.K.iw = { Xo: a.data.Xo, oj: a.data.oj };
            gvjs_LK(c.zb, 0);
        }, 300);
        return !0;
    }
    ...
    switch (b.type) {
        ...
        case gvjs_oZ:
            if (b.data.Ro) {
                ...
                b.data.iJ && !d
                    ? gvjs_b_(a)
                    : c && (b.data.hD ? gvjs_b_(a) : gvjs_a_(a));
            } else
                null === a.SB &&
                    ((c = b.elementType == gvjs_vZ),
                    (b.data.iJ || c) && gvjs_c_(a));
            return !1;
        case gvjs_pZ:
            return (
                b.elementType == gvjs_uZ ? (gvjs_c_(a), (a = !0)) : (a = !1), a
            );
        default:
            return !1;
    }
...
function gvjs_Ila(a, b, c, d, e, f) {
    ...
    if (a.Dq("keepAspectRatio")) {
        ...
        g = new gvjs_5(
            Math.round((h - m) / 2) + g.left,
            Math.round((k - l) / 2) + g.top,
            m,
            l
        );
    } else g = g.clone();
    ...
    this.n9 = gvjs_Oj(
        a,
        gvjs_zp,
        Math.round(Math.pow(2 * (this.ms.width + this.ms.height), 1 / 3))
    );
    this.bta = gvjs_oy(
        a,
        ["marker.style.stroke.color", "marker.style.stroke"],
        gvjs_yr
    );
    ...
    this.ica = gvjs_ry(a, gvjs_vv, { bb: this.PX, fontSize: this.n9 });
...
function gvjs_h_(a, b) {
    ...
    a = c.getBounds("x");
    c = c.getBounds("y");
    return { xi: [c.max, a.max], kh: [c.min, a.min] };
}
function gvjs_Nla(a, b, c) {
    var d = new gvjs_5(
            b.hza * a.lw.width + a.lw.left,
            b.pza * a.lw.height + a.lw.top,
            b.scale * a.lw.width,
            b.scale * a.lw.height
        ),
        e = a.BK[c],
...
function gvjs_i_(a, b, c, d, e) {
    for (
        a = gvjs_Ola(a, gvjs_Rz(gvjs_Oz(e.polygons), gvjs_Oz(e.Rm)));
        a[1] > b.xi[1];
...
function gvjs_Qla(a) {
    for (var b = 0; b < a.length; b++) {
        for (
            var c = a[b], d = new gvjs_z(c.x, c.y), e = 0, f = 0;
            f < a.length;
            f++
        )
            if (b != f) {
...
function gvjs_Rla(a, b, c) {
    ...
    for (h = 0; h < d.length; h++)
        (k = d[h].location), null != k && gvjs_Me(g, gvjs_m_(a, h, k, [c]));
    return { Xo: b, Bca: e, view: c, FD: g };
}
function gvjs_o_(a, b) {
    ...
    f.top =
        a.XQ === gvjs_AZ || "top_right" === a.XQ
            ? 3 * c
            : a.VQ === gvjs_U
            ? e - c - f.width
            : e - c - f.height;
    f.left =
        a.XQ === gvjs_AZ || a.XQ === gvjs_lZ
            ? 0.5 * c
            : a.VQ == gvjs_U
            ? d - c - f.height
            : d - c - f.width;
...
function gvjs_Sla(a, b) {
    ...
    gvjs_u(
        ...
        function (h) {
            ...
            h
                ? (c.NC.push(h.id),
                  d &&
                      ((q = r = new gvjs_z(h.center[0], h.center[1])),
                      c.qu.push(gvjs_kG(k, l, !1, r, n, q, void 0, this.Q_))))
                : p &&
                  gvjs_w(
                      p.SX,
                      function (t, u) {
    ...
    if (null != b.Nj) {
        if (a.wz && (a.tF === gvjs_ut || a.tF === gvjs_xu)) {
            ...
            c.qu.push(
                gvjs_kG(
                    ...
                    a.Zd,
                    !1,
                    new gvjs_z(g.x - f, g.y - f),
                    new gvjs_B(0, a.ga - 1, a.Pa - 1, 0),
                    g,
                    void 0,
                    a.Q_
                )
        ...
        null != a.gb.Yu &&
            ((e = { value: a.Z.getValue(b.Nj.oj, a.gb.Yu) }),
            (c.Vi = gvjs_o_(a, [e])));
    }
...
function gvjs_q_(a, b, c) {
    ...
    if (null != c)
        if (((d = d.m5), e.Bd(d, gvjs_av) || e.getProperty(b, d, gvjs_av)))
            f.entries.push(
                gvjs_hG(c, a.pu.Hd, void 0, void 0, void 0, void 0, void 0, !0)
            );
        else
            for (b = c.split("\n"), e = 0; e < b.length; e++)
                (d = gvjs_hG(b[e], a.pu.Hd)), f.entries.push(d);
    else
        null != d.Yu &&
            ((c = e.Ga(d.Yu)),
            (g = e.Ha(b, d.Yu)),
...
function gvjs_g_(a, b) {
    ...
    c = gvjs_uj(gvjs_1z(c, 0.1));
    return {
        fill: new gvjs_3({ stroke: c, fill: b }),
        Rm: new gvjs_3({
            stroke: gvjs_f,
            pattern: new gvjs_$x(gvjs_rw, b, b == a.O7 ? gvjs_Br : a.O7),
        }),
        border: new gvjs_3({ stroke: c }),
    };
}
...
gvjs_.U3 = function (a, b) {
    ...
    for (var e = [], f = 0, g = a.views.length; f < g; f++) {
        var h = a.views[f],
            k = c.I2.Zc();
        k.boundingBox = { lo: h.Ju.kh, hi: h.Ju.xi };
        k = new c.I2.constructor(k);
        c.BK.push(k);
        k = gvjs_Nla(c, h, f);
        e.push(k);
        c.FF.push({ features: h.features, NX: k });
    }
    a = {
        width: c.ga,
        height: c.Pa,
        ...
        title: {
            ...
            ja: gvjs_ry(d, gvjs_ix, { bb: c.PX, fontSize: c.n9 }),
            lines: [],
            align: gvjs_2,
            tooltip: "",
        },
...
function gvjs_Tla(a, b, c, d, e, f) {
    function g() {
        ...
        for (var k = {}, l = 0; l < h.Z.ca(); ++l) {
            ...
            if (null != m) {
                var n = h.w8(l);
                null != n && (k[m] = { oj: l, Rb: gvjs_g_(h, n) });
            }
        }
        h = { qC: k, FD: gvjs_Pla(h, c), Vi: gvjs_o_(h, []) };
        a.nL(1, h);
        a.Qt();
    }
    a.O2 = !1;
...
function gvjs_s_(a, b) {
    null != a.K.Nj &&
        b.data.xb &&
        ((a.K.Nj.origin = { x: b.data.xb.x, y: b.data.xb.y }),
        gvjs_LK(a.zb, 3));
}
gvjs_.et = function (a, b) {
    a = this.CD.compact().FE == gvjs_Ww;
    null != b
        ? (gvjs_ty(this.K.selection, b, a), this.Xm(gvjs_k, {}))
        : ((b = 0 < this.K.selection.getSelection().length),
...
gvjs_.S2 = function () {
    ...
    this.cm.o(gvjs_nZ, function (b) {
        if (!gvjs_t_(a, b) && a.Q9) {
            ...
            null !== c && a.Xm("regionClick", { region: c });
            c = gvjs_u_(a, c);
            a.et(b, c);
        }
    });
                      ...
                      (a.K.Nj =
                          null != c
                              ? {
                                    oj: c,
                                    gJ: b.data.gJ,
                                    origin: { x: b.data.xb.x, y: b.data.xb.y },
                                }
                              : null))
                    : ((a.K.ff = null), (a.K.Nj = null)),
                gvjs_LK(a.zb, 50));
        }
    });
...
function gvjs_z_(a, b, c, d) {
    gvjs_fn(gvjs_y_ + "/" + a + "/" + (b + ".js")).then(
        function (e) {
            e = e.replace(
                /^[\s\S]*google_visualization_geochart_[^=]*\s*=\s*/g,
                ""
            );
            e = e.replace(/;[\s]*$/g, "");
            e = JSON.parse(e);
...
function gvjs_Wla(a, b) {
    ...
    if (void 0 !== gvjs_w_[d])
        ...
        gvjs_z_(
            ...
            c,
            function (f) {
                f = { views: gvjs_v(f.views, gvjs_Zla) };
                gvjs_w_[d] = f;
                e(f);
            },
            function () {
...
function gvjs_2la(a) {
    ...
    if ((b = gvjs_A_[b])) if ((b = b[a])) return 0 <= gvjs_Iy(b, c);
    return !1;
}
function gvjs_Zla(a) {
    for (
        var b = gvjs_v(a.features, gvjs_3la), c = {}, d = [], e = 0;
        e < b.length;
        e++
    ) {
        var f = b[e],
...
function gvjs_3la(a) {
    return { id: a.id, polygons: gvjs_v(a.polygons, gvjs_5la), Rm: [] };
}
function gvjs_5la(a) {
    return gvjs_ne(a)
        ? { pL: gvjs_B_(a), SI: [] }
        : { pL: gvjs_B_(a.shell), SI: gvjs_v(a.holes, gvjs_B_) };
}
function gvjs_B_(a) {
...
function gvjs_C_(a, b, c, d) {
    ...
    if (e != gvjs_ub) d(gvjs_D_(e, c));
        ...
        var f = c.cb(gvjs_yT, gvjs_DZ),
            ...
            h = [];
        for (e = 0; e < a.ca(); ++e)
            h.push({ lat: a.getValue(e, b.sD), lng: a.getValue(e, b.yD) });
        gvjs__la(function (k) {
            if (k) {
                a: {
...
function gvjs_D_(a, b) {
    ...
    b = gvjs_J(b, gvjs_mu);
    a = { region: a, resolution: c, domain: b };
    return gvjs_2la(a) ||
        ("COM" != a.domain && ((a.domain = "COM"), gvjs_2la(a)))
        ? a
        : null;
}
...
gvjs_.Rd = function (a, b, c, d) {
    ...
    if (null != p) {
        var q = gvjs_Bi({ options: c, format: p, size: this.eb }),
...
gvjs_.Bv = function (a, b) {
    ...
    -1 == a && -1 == b
        ? ((a = 556), (b = 347))
        : -1 == a
        ? (a = Math.round((556 * b) / 347))
        : -1 == b && (b = Math.round((347 * a) / 556));
...
function gvjs_$la(a, b, c, d, e, f, g, h, k) {
    ...
    b &&
        ...
        gvjs_Wla(
            ...
            a.Bk(function (p) {
                null != p
                    ? (a.Ak.U3(p, f), m && (a.Hz.U3(p), l()), (a.f0 = k))
                    : a.Hg.Sc(gvjs_jZ);
            })
        ));
    m || ((a.Hz.aF = null), l());
