...
!(function (e, t) {
    ...
    function T(e, t) {
        ...
        return (
            r.WebKitCSSMatrix
                ? ((s = n.transform || n.webkitTransform).split(",").length >
                      6 &&
                      (s = s
                          .split(", ")
                          .map(function (e) {
        ...
        V = {
            ...
            update: {
                ...
                updateSlides: function () {
                    ...
                    "function" == typeof v &&
                        (v = t.slidesOffsetBefore.call(this));
                            ...
                            0 !== t.spaceBetween &&
                                (this.isHorizontal()
                                    ? a
                                        ...
                                        : d
                                              .filter(f)
                                              .css({ marginRight: y + "px" })
                                    : d
                                          .filter(f)
                                          .css({ marginBottom: y + "px" })),
                ...
                updateSlidesClasses: function () {
                    ...
                    i.loop &&
                        0 === l.length &&
                        (l = t.eq(0)).addClass(i.slideNextClass);
                    var o = e
                ...
                updateActiveIndex: function (e) {
                    ...
                    if ((t >= a.length && (t = a.length - 1), d !== n)) {
                        var u = parseInt(
                            this.slides.eq(d).attr("data-swiper-slide-index") ||
                                d,
                            10
                        );
                        S(this, {
            ...
            slide: {
                slideTo: function (e, t, i, s) {
                    ...
                    if ((r.updateProgress(g), l.normalizeSlideIndex))
                        for (var w = 0; w < d.length; w += 1)
                            -Math.floor(100 * g) >= Math.floor(100 * d[w]) &&
                                (n = w);
                ...
                slideToClosest: function (e, t, i, s) {
                    ...
                    var a = this.activeIndex,
                        ...
                        n =
                            r +
                            Math.floor((a - r) / this.params.slidesPerGroup),
                        l = this.rtlTranslate
                            ? this.translate
                            : -this.translate;
                    ...
                    if (t < s)
                        (e = i.length - 3 * s + t),
                            ...
                            this.slideTo(e, 0, !1, !0) &&
                                0 !== o &&
                                this.setTranslate(
                                    (l ? -this.translate : this.translate) - o
                                );
                ...
                addSlide: function (e, t) {
                    ...
                    if (e <= 0) this.prependSlide(t);
                        ...
                        s.loop && this.loopCreate(),
                            (s.observer && this.support.observer) ||
                                this.update(),
                            s.loop
                        ...
                        if (l && this.currentBreakpoint !== l) {
                            ...
                            h && !p
                                ...
                                : !h &&
                                  p &&
                                  (r.addClass(
                                      a.containerModifierClass + "multirow"
                                  ),
                            ...
                            var u = d.direction && d.direction !== a.direction,
                                c =
                                    a.loop &&
                                    (d.slidesPerView !== a.slidesPerView || u);
                ...
                (r.destroy = function (e, t) {
                    ...
                    return (
                        void 0 === s.params ||
                            ...
                            s.emit("destroy"),
                            Object.keys(s.eventsListeners).forEach(function (
                                e
                            ) {
                                s.off(e);
                            }),
    ...
    var U = {
            ...
            animateSlider: function (e) {
                ...
                return (
                    ...
                    ((e.delta >= 6 &&
                        x() - this.mousewheel.lastScrollTime < 60) ||
                        (e.direction < 0
                        ...
                        (this.mousewheel.lastScrollTime =
                            new t.Date().getTime()),
                        !1))
                );
            },
                    ...
                    if (
                        ...
                        if (
                            ...
                            var h = d.eq(i),
                                p = h.index();
                            if (
                                (h.addClass(t.bulletActiveClass),
                                t.dynamicBullets)
                            ) {
                                for (
                                    var u = d.eq(n), c = d.eq(l), f = n;
                                    f <= l;
                                    f += 1
                                )
                                    d.eq(f).addClass(
                                ...
                                if (this.params.loop)
                                    if (p >= d.length - t.dynamicMainBullets) {
                                        ...
                                        d.eq(
                                            d.length - t.dynamicMainBullets - 1
                                        ).addClass(
            ...
            onGestureChange: function (e) {
                ...
                a.$imageEl && 0 !== a.$imageEl.length
                    ? (t.gestures
                          ...
                          : (s.scale =
                                (a.scaleMove / a.scaleStart) * s.currentScale),
                      s.scale > a.maxRatio &&
                          (s.scale =
                              a.maxRatio -
                              1 +
                              Math.pow(s.scale - a.maxRatio + 1, 0.5)),
                      s.scale < i.minRatio &&
                          (s.scale =
                              i.minRatio +
                              1 -
        ...
        se = {
            ...
            init: function () {
                ...
                t.containerRoleDescriptionMessage &&
                    ...
                    t.containerMessage &&
                        e.a11y.addElLabel(i, t.containerMessage);
                var s,
                    a,
                    r,
                    n = e.$wrapperEl,
        ...
        ue = [
            ...
            },
            {
                ...
                create: function () {
                    M(this, {
                        autoplay: t(t({}, ne), {}, { running: !1, paused: !1 }),
                    });
                },
                on: {
                    init: function (e) {
            ...
            },
            {
                ...
                create: function () {
                    M(this, {
                        thumbs: t({ swiper: null, initialized: !1 }, pe),
                    });
                },
                on: {
                    beforeInit: function (e) {
