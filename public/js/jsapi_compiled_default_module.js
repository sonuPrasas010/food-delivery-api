...
var gvjs_aa = " does not match type ",
    ...
    gvjs_ia = ', for column "',
    gvjs_ja = ".format",
    gvjs_ka = "0000000000000000",
    gvjs_a = "</div>",
    gvjs_la = "<br>",
    gvjs_ma = "AnnotatedTimeLine",
    gvjs_na = "AreaChart",
    gvjs_oa = "AreaChart-stacked",
    gvjs_pa = "August",
    gvjs_qa = "BarChart",
    gvjs_ra = "BubbleChart",
    gvjs_sa = "CSSStyleDeclaration",
    gvjs_ta = "Can't combine significant digits and minimum fraction digits",
    gvjs_ua = "CandlestickChart",
    gvjs_va = "Clobbering detected",
    gvjs_wa = "Column ",
    gvjs_xa = "ColumnChart",
    gvjs_ya = "ComboChart",
    gvjs_za = "Container is not defined",
    gvjs_Aa = "Custom response handler must be a function.",
    gvjs_b = "DIV",
    gvjs_Ba = "December",
    gvjs_Ca = "Edge",
    gvjs_Da = "Element",
    ...
    gvjs_Ia = "HH:mm",
    gvjs_Ja = "HH:mm:ss",
    gvjs_Ka = "HH:mm:ss.SSS",
    gvjs_La = "Histogram",
    gvjs_Ma = "IFRAME",
    gvjs_Na = "INPUT",
    gvjs_Oa = "ImageRadarChart",
    gvjs_Pa = "ImageSparkLine",
    gvjs_Qa = "Inconsistent use of percent/permill characters",
    gvjs_Ra = "Invalid DataView column type.",
    gvjs_Sa = "Invalid data table format: column #",
    gvjs_Ta = "Invalid value for numOrArray: ",
    gvjs_Ua = "January",
    gvjs_Va = "LineChart",
    gvjs_Wa = "Map",
    gvjs_Xa = "May",
    ...
    gvjs_2a = "OrgChart",
    gvjs_3a = "PieChart",
    gvjs_4a = "Request timed out",
    gvjs_5a = "SOURCE",
    gvjs_6a = "SPAN",
    gvjs_7a = "STYLE",
    gvjs_8a = "Saturday",
    gvjs_9a = "ScatterChart",
    gvjs_$a = "September",
    gvjs_ab = "SteppedAreaChart",
    gvjs_bb = "Sunday",
    gvjs_cb = "Symbol.iterator",
    gvjs_db = "Table",
    gvjs_eb = "Thursday",
    gvjs_fb = "Timeline",
    gvjs_gb = "Too many percent/permill",
    gvjs_hb = "TreeMap",
    gvjs_ib = "Tuesday",
    gvjs_jb = "Type mismatch. Value ",
    gvjs_kb = "Uneven number of arguments",
    gvjs_lb = "Wednesday",
    gvjs_mb = "WordTree",
    gvjs_nb = "_bar_format_old_value",
    gvjs_ob = "about:invalid#zClosurez",
    gvjs_c = "absolute",
    gvjs_pb = "addTrendLine",
    gvjs_qb = "annotatedtimeline",
    gvjs_rb = "annotationchart",
    gvjs_sb = "array",
    gvjs_tb = "attributes",
    gvjs_ub = "auto",
    gvjs_vb = "background-color:",
    gvjs_wb = "bar",
    gvjs_xb = "block",
    gvjs_yb = "body",
    gvjs_zb = "boolean",
    ...
    gvjs_Eb = "color:",
    gvjs_Fb = "column",
    gvjs_Gb = "columnFilters[",
    gvjs_Hb = "complete",
    gvjs_Ib = "controls",
    gvjs_Jb = "corechart",
    gvjs_Kb = "data-sanitizer-",
    gvjs_Lb = "date",
    gvjs_Mb = "datetime",
    gvjs_Nb = "decimal",
    gvjs_Ob = "div",
    ...
    gvjs_Wb = "getElementsByTagName",
    gvjs_Xb = "getPropertyValue",
    gvjs_Yb = "google.charts.",
    gvjs_Zb = "google.charts.Bar",
    gvjs__b = "google.charts.Line",
    gvjs_0b = "google.charts.Scatter",
    gvjs_1b = "google.visualization.",
    gvjs_2b = "google.visualization.AnnotatedTimeLine",
    gvjs_3b = "google.visualization.AnnotationChart",
    gvjs_4b = "google.visualization.AreaChart",
    gvjs_5b = "google.visualization.BarChart",
    gvjs_6b = "google.visualization.BubbleChart",
    gvjs_7b = "google.visualization.Bubbles",
    gvjs_8b = "google.visualization.CandlestickChart",
    gvjs_9b = "google.visualization.CategoryFilter",
    gvjs_$b = "google.visualization.ChartRangeFilter",
    gvjs_ac = "google.visualization.ChartRangeFilterUi",
    gvjs_bc = "google.visualization.ClusterChart",
    gvjs_cc = "google.visualization.ColumnChart",
    gvjs_dc = "google.visualization.ColumnSelector",
    gvjs_ec = "google.visualization.ComboChart",
    gvjs_fc = "google.visualization.CoreChart",
    gvjs_gc = "google.visualization.Dashboard",
    gvjs_hc = "google.visualization.DashboardWrapper",
    gvjs_ic = "google.visualization.DateRangeFilter",
    gvjs_jc = "google.visualization.DateRangeFilterUi",
    gvjs_kc = "google.visualization.Filter",
    gvjs_lc = "google.visualization.Gantt",
    gvjs_mc = "google.visualization.Gauge",
    gvjs_nc = "google.visualization.GeoChart",
    gvjs_oc = "google.visualization.GeoMap",
    gvjs_pc = "google.visualization.HeadlessUi",
    gvjs_qc = "google.visualization.HelloWorld",
    gvjs_rc = "google.visualization.Histogram",
    gvjs_sc = "google.visualization.ImageAreaChart",
    gvjs_tc = "google.visualization.ImageBarChart",
    gvjs_uc = "google.visualization.ImageCandlestickChart",
    gvjs_vc = "google.visualization.ImageChart",
    gvjs_wc = "google.visualization.ImageLineChart",
    gvjs_xc = "google.visualization.ImagePieChart",
    gvjs_yc = "google.visualization.ImageSparkLine",
    gvjs_zc = "google.visualization.LineChart",
    gvjs_Ac = "google.visualization.Map",
    gvjs_Bc = "google.visualization.Matrix",
    gvjs_Cc = "google.visualization.MotionChart",
    gvjs_Dc = "google.visualization.NumberFormat",
    gvjs_Ec = "google.visualization.NumberRangeFilter",
    gvjs_Fc = "google.visualization.NumberRangeSetter",
    gvjs_Gc = "google.visualization.NumberRangeUi",
    gvjs_Hc = "google.visualization.Operator",
    gvjs_Ic = "google.visualization.OrgChart",
    gvjs_Jc = "google.visualization.PieChart",
    gvjs_Kc = "google.visualization.Query",
    gvjs_Lc = "google.visualization.RangeSelector",
    gvjs_Mc = "google.visualization.Sankey",
    gvjs_Nc = "google.visualization.ScatterChart",
    gvjs_Oc = "google.visualization.SelectorUi",
    gvjs_Pc = "google.visualization.SparklineChart",
    gvjs_Qc = "google.visualization.SteppedAreaChart",
    gvjs_Rc = "google.visualization.Streamgraph",
    gvjs_Sc = "google.visualization.StringFilter",
    gvjs_Tc = "google.visualization.StringFilterUi",
    gvjs_Uc = "google.visualization.Sunburst",
    gvjs_Vc = "google.visualization.Table",
    gvjs_Wc = "google.visualization.TableTextChart",
    gvjs_Xc = "google.visualization.Timeline",
    gvjs_Yc = "google.visualization.TreeMap",
    gvjs_Zc = "google.visualization.VegaChart",
    gvjs__c = "google.visualization.Version",
    gvjs_0c = "google.visualization.WordTree",
    gvjs_1c = "google.visualization.WordcloudChart",
    gvjs_2c = "hasAttribute",
    gvjs_3c = "hasLabelsColumn",
    gvjs_4c = "height",
    gvjs_5c = "id",
    gvjs_6c = "imagechart",
    gvjs_7c = "keypress",
    ...
    gvjs_yd = "regions",
    gvjs_zd = "relative",
    gvjs_Ad = "removeAttribute",
    gvjs_j = "right",
    gvjs_Bd = "role",
    gvjs_Cd = "row",
    gvjs_Dd = "scatter",
    gvjs_Ed = "script[nonce]",
    gvjs_k = "select",
    gvjs_Fd = "setAttribute",
    gvjs_Gd = "short",
    gvjs_Hd = "statechange",
    gvjs_l = "string",
    gvjs_Id = "stringify",
    ...
    gvjs_Rd = "true",
    gvjs_Sd = "type",
    gvjs_Td = "unhandledrejection",
    gvjs_Ud = "vAxis",
    gvjs_Vd = "value",
    gvjs_Wd = "warning",
    gvjs_Xd = "width",
    gvjs_Yd = "withCredentials",
    gvjs_Zd = "wordtree",
    gvjs__d = "zClosurez",
    gvjs_0d = "{1} 'at' {0}",
    gvjs_1d = "{1}, {0}",
...
var gvjs_4d =
    typeof Object.defineProperties == gvjs_d
...
function gvjs_aaa(a) {
    a = [
        gvjs_h == typeof globalThis && globalThis,
        a,
        gvjs_h == typeof window && window,
        gvjs_h == typeof self && self,
        gvjs_h == typeof global && global,
    ];
...
function gvjs_6d(a, b) {
    if (b)
        a: {
            ...
            b != d &&
                null != b &&
                gvjs_4d(c, a, { configurable: !0, writable: !0, value: b });
        }
}
...
gvjs_6d(gvjs_cb, function (a) {
    ...
    for (
        ...
        var d = gvjs_5d[b[c]];
        typeof d === gvjs_d &&
            typeof d.prototype[a] != gvjs_d &&
            gvjs_4d(d.prototype, a, {
                configurable: !0,
                writable: !0,
                value: function () {
...
function gvjs_8d(a) {
    ...
    return b ? b.call(a) : { next: gvjs_3d(a) };
}
function gvjs_9d(a) {
...
var gvjs_baa =
    ...
    gvjs_$d;
if (typeof Object.setPrototypeOf == gvjs_d) gvjs_$d = Object.setPrototypeOf;
else {
    var gvjs_ae;
    a: {
        var gvjs_caa = { a: !0 },
...
gvjs_6d("WeakMap", function (a) {
    ...
    b.prototype.set = function (k, l) {
        ...
        e(k);
        if (!gvjs_de(k, g)) throw Error("WeakMap key fail: " + k);
        k[g][this.ac] = l;
        return this;
    };
        ...
        if (m && gvjs_de(h.ra, l))
            for (h = 0; h < m.length; h++) {
                ...
                if ((k !== k && n.key !== n.key) || k === n.key)
                    return { id: l, list: m, index: h, Xc: n };
            }
        return { id: l, list: m, index: -1, Xc: void 0 };
    }
    function e(h) {
        this.ra = {};
        this.pc = b();
...
function gvjs_fe(a, b, c) {
    ...
    for (var d = a.length, e = 0; e < d; e++) {
        var f = a[e];
        if (b.call(c, f, e, a)) return { Ud: e, v: f };
    }
    return { Ud: -1, v: void 0 };
}
...
var gvjs_daa =
    typeof Object.assign == gvjs_d
        ? Object.assign
        : function (a, b) {
              for (var c = 1; c < arguments.length; c++) {
                  var d = arguments[c];
                  if (d) for (var e in d) gvjs_de(d, e) && (a[e] = d[e]);
              }
              return a;
          };
...
gvjs_6d("Promise", function (a) {
    ...
    b.prototype.Xta = function () {
        if (this.Mba) return !1;
        var g = gvjs_5d.CustomEvent,
            h = gvjs_5d.Event,
            k = gvjs_5d.dispatchEvent;
        if ("undefined" === typeof k) return !0;
        typeof g === gvjs_d
            ? (g = new g(gvjs_Td, { cancelable: !0 }))
            : typeof h === gvjs_d
            ? (g = new h(gvjs_Td, { cancelable: !0 }))
    ...
    b.prototype.Yna = function () {
        if (null != this.WD) {
            for (var g = 0; g < this.WD.length; ++g) f.u7(this.WD[g]);
            this.WD = null;
        }
    };
    var f = new c();
...
gvjs_6d("Object.values", function (a) {
    return a
        ...
        : function (b) {
              var c = [],
                  d;
              for (d in b) gvjs_de(b, d) && c.push(b[d]);
              return c;
          };
});
...
gvjs_6d("Object.entries", function (a) {
    return a
        ...
        : function (b) {
              var c = [],
                  d;
              for (d in b) gvjs_de(b, d) && c.push([d, b[d]]);
              return c;
          };
});
...
function gvjs_pe(a) {
    return (
        (Object.prototype.hasOwnProperty.call(a, gvjs_qe) && a[gvjs_qe]) ||
        (a[gvjs_qe] = ++gvjs_eaa)
    );
}
...
function gvjs_ve(a) {
    if (Error.captureStackTrace) Error.captureStackTrace(this, gvjs_ve);
    else {
        var b = Error().stack;
        b && (this.stack = b);
    }
...
var gvjs_Be = Array.prototype.indexOf
        ? function (a, b) {
              return Array.prototype.indexOf.call(a, b, void 0);
          }
        : function (a, b) {
              if (typeof a === gvjs_l)
                  return typeof b !== gvjs_l || 1 != b.length
                      ? -1
                      : a.indexOf(b, 0);
              for (var c = 0; c < a.length; c++)
    ...
    gvjs_haa = Array.prototype.lastIndexOf
        ? function (a, b) {
    ...
    gvjs_u = Array.prototype.forEach
        ? function (a, b, c) {
...
var gvjs_De = Array.prototype.filter
        ? function (a, b, c) {
    ...
    gvjs_Ee = Array.prototype.reduce
        ? function (a, b, c, d) {
              d && (b = gvjs_s(b, d));
    ...
    gvjs_iaa = Array.prototype.reduceRight
        ? function (a, b, c) {
...
function gvjs_8e(a) {
    return a instanceof gvjs_5e &&
        a.constructor === gvjs_5e &&
        a.Hja === gvjs_7e
        ? a.nga
        : "type_error:Const";
}
...
function gvjs_bf(a) {
    if (a instanceof gvjs_af && a.constructor === gvjs_af) return a.B2;
    gvjs_me(a);
...
function gvjs_ff(a) {
    if (a instanceof gvjs_cf && a.constructor === gvjs_cf) return a.G2;
    gvjs_me(a);
...
var gvjs_kf = String.prototype.trim
    ? function (a) {
          return a.trim();
      }
    : function (a) {
...
function gvjs_lf(a, b) {
    if (b)
        a = a
            .replace(gvjs_mf, "&amp;")
            .replace(gvjs_nf, gvjs_fa)
            .replace(gvjs_of, "&gt;")
            .replace(gvjs_pf, gvjs_ga)
            .replace(gvjs_qf, "&#39;")
            .replace(gvjs_rf, "&#0;");
    else {
        if (!gvjs_maa.test(a)) return a;
    ...
    for (var d = Math.max(a.length, b.length), e = 0; 0 == c && e < d; e++) {
        ...
        do {
            ...
            c =
                ...
                gvjs_uf(0 == f[2].length, 0 == g[2].length) ||
                gvjs_uf(f[2], g[2]);
            f = f[3];
            g = g[3];
        } while (0 == c);
...
function gvjs_xf(a) {
    if (a instanceof gvjs_vf && a.constructor === gvjs_vf) return a.E2;
    gvjs_me(a);
...
function gvjs_Ff(a) {
    if (a instanceof gvjs_Df && a.constructor === gvjs_Df) return a.D2;
    gvjs_me(a);
...
function gvjs_Hf(a) {
    ...
    for (c in a)
        if (Object.prototype.hasOwnProperty.call(a, c)) {
            ...
            var d = a[c];
            null != d &&
                ((d = Array.isArray(d) ? d.map(gvjs_If).join(" ") : gvjs_If(d)),
                (b += c + ":" + d + ";"));
        }
...
function gvjs_If(a) {
    if (a instanceof gvjs_vf)
        return (
            'url("' +
            gvjs_xf(a).replace(/</g, "%3c").replace(/[\\"]/g, "\\$&") +
            '")'
        );
...
function gvjs_paa(a) {
    var b = a
        ...
        .replace(gvjs_Kf, "url");
    if (gvjs_qaa.test(b)) {
        if (gvjs_raa.test(a)) return gvjs__d;
        for (var c = (b = !0), d = 0; d < a.length; d++) {
            var e = a.charAt(d);
            "'" == e && c ? (b = !b) : '"' == e && b && (c = !c);
        }
        if (!b || !c || !gvjs_saa(a)) return gvjs__d;
    } else return gvjs__d;
    return gvjs_taa(a);
}
function gvjs_saa(a) {
...
function gvjs_Nf(a, b) {
    if (gvjs_sf(a, "<")) throw Error("Selector does not allow '<', got: " + a);
    var c = a.replace(/('|")((?!\1)[^\r\n\f\\]|\\[\s\S])*\1/g, "");
    if (!/^[-_a-zA-Z0-9#.:* ,>+~[\]()=^$|]+$/.test(c))
        throw Error(
...
function gvjs_Pf(a) {
    if (a instanceof gvjs_Mf && a.constructor === gvjs_Mf) return a.C2;
    gvjs_me(a);
...
function gvjs_Yf() {
    return (
        gvjs_Uf("Android") &&
        !(gvjs_Xf() || gvjs_Vf() || gvjs_Uf("Opera") || gvjs_Uf("Silk"))
    );
}
...
function gvjs_1f(a) {
    if (a instanceof gvjs_Zf && a.constructor === gvjs_Zf) return a.A2;
    gvjs_me(a);
    return "type_error:SafeHtml";
}
function gvjs_2f(a) {
    if (a instanceof gvjs_Zf) return a;
...
function gvjs_6f(a) {
    if (!gvjs_4f.test(a)) throw Error("");
    if (a.toUpperCase() in gvjs_vaa) throw Error("");
}
function gvjs_waa(a) {
    var b = { nonce: gvjs_8f(gvjs_Ed, void 0) };
    for (d in b)
    ...
    var d = "";
    a = gvjs_Ke(a);
    for (c = 0; c < a.length; c++) d += gvjs_bf(a[c]).toString();
    a = gvjs_3f(d, 0);
...
function gvjs_ag(a) {
    ...
    if (a)
        for (var c in a)
            if (Object.prototype.hasOwnProperty.call(a, c)) {
                if (!gvjs_4f.test(c)) throw Error("");
                var d = a[c];
                if (null != d) {
                    var e = c;
                    if (d instanceof gvjs_5e) d = gvjs_8e(d);
                    else if (e.toLowerCase() == gvjs_Jd) {
                        if (!gvjs_r(d)) throw Error("");
                        d instanceof gvjs_Df || (d = gvjs_Hf(d));
                        d = gvjs_Ff(d);
                    } else {
                        if (/^on/i.test(e)) throw Error("");
                        if (e.toLowerCase() in gvjs_uaa)
                            if (d instanceof gvjs_cf) d = gvjs_ef(d);
                            else if (d instanceof gvjs_vf) d = gvjs_xf(d);
                            else if (typeof d === gvjs_l) d = gvjs_Bf(d).Tk();
                            else throw Error("");
                    }
                    d.Po && (d = d.Tk());
...
var gvjs_yaa = gvjs_3f("<!DOCTYPE html>", 0),
    gvjs_9f = new gvjs_Zf(
        (gvjs_p.trustedTypes && gvjs_p.trustedTypes.emptyHTML) || "",
        0,
        gvjs__f
    ),
...
function gvjs_cg(a, b) {
    if (gvjs_zaa()) for (; a.lastChild; ) a.removeChild(a.lastChild);
...
function gvjs_8f(a, b) {
    ...
    return b.querySelector
        ? (a = b.querySelector(a)) &&
          (a = a.nonce || a.getAttribute(gvjs_qd)) &&
          gvjs_Aaa.test(a)
            ? a
            : ""
        : "";
...
var gvjs_eg = String.prototype.repeat
    ? function (a, b) {
          return a.repeat(b);
      }
    : function (a, b) {
...
function gvjs_hg() {
    return (
        ...
        Math.abs(Math.floor(2147483648 * Math.random()) ^ gvjs_se()).toString(
            36
        )
    );
}
...
var gvjs_qg = gvjs_Uf("Opera"),
    ...
    gvjs_sg =
        gvjs_Uf("Gecko") &&
        !(gvjs_sf(gvjs_Rf.toLowerCase(), "webkit") && !gvjs_Uf(gvjs_Ca)) &&
        !(gvjs_Uf("Trident") || gvjs_Uf("MSIE")) &&
        !gvjs_Uf(gvjs_Ca),
...
a: {
    var gvjs_Ag = "",
        gvjs_Bg = (function () {
            var a = gvjs_Rf;
            if (gvjs_sg) return /rv:([^\);]+)(\)|;)/.exec(a);
            if (gvjs_rg) return /Edge\/([\d\.]+)/.exec(a);
            if (gvjs_y) return /\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/.exec(a);
            if (gvjs_tg) return /WebKit\/(\S+)/.exec(a);
            if (gvjs_qg) return /(?:Version)[ \/]?(\S+)/.exec(a);
        })();
...
function gvjs_Qg(a, b, c) {
    return typeof a === gvjs_h
        ? gvjs_Og && !Array.isArray(a) && a instanceof Uint8Array
            ? c(a)
            : gvjs_Pg(a, b, c)
        : b(a);
}
function gvjs_Pg(a, b, c) {
    ...
    d = {};
    for (e in a) (f = a[e]), null != f && (d[e] = gvjs_Qg(f, b, c));
    return d;
}
var gvjs_Oaa = { osa: { value: !0, configurable: !0 } };
function gvjs_Rg(a) {
    Array.isArray(a) &&
        !Object.isFrozen(a) &&
        Object.defineProperties(a, gvjs_Oaa);
    return a;
}
function gvjs_Sg() {}
var gvjs_Tg;
function gvjs_Ug(a, b, c) {
    a.se = null;
    gvjs_Tg && (b || (b = gvjs_Tg), (gvjs_Tg = null));
        ...
        if ((b = a.array.length))
            if (
                ...
                !(
                    ...
                    typeof d != gvjs_h ||
                    Array.isArray(d) ||
                    (gvjs_Og && d instanceof Uint8Array)
                ))
            ) {
                a.tK = b - a.qG;
                a.Kl = d;
    ...
    if (c)
        for (b = 0; b < c.length; b++)
            ...
            } else gvjs_Wg(a), (e = a.Kl[d]) ? gvjs_Rg(e) : (a.Kl[d] = gvjs_Vg);
}
...
function gvjs_Xg(a, b) {
    ...
    if (a.Kl) return (c = a.Kl[b]), c !== gvjs_Vg ? c : (a.Kl[b] = gvjs_Rg([]));
}
...
gvjs_.um = function () {
    if (this.se)
        for (var a in this.se) {
            var b = this.se[a];
            if (Array.isArray(b))
                for (var c = 0; c < b.length; c++) b[c] && b[c].um();
            else b && b.um();
        }
    return this.array;
};
...
function gvjs_Paa(a, b) {
    switch (typeof b) {
        case gvjs_g:
            return isNaN(b) || Infinity === b || -Infinity === b
                ? String(b)
                : b;
        case gvjs_h:
...
gvjs_.getExtension = function (a) {
    ...
    return a.WDa
        ? a.jsa()
            ? (this.se[b] ||
                  (this.se[b] = gvjs_v(this.Kl[b] || [], function (c) {
                      return new a.nma(c);
                  })),
              this.se[b])
            : (this.Kl[b] = this.Kl[b] || gvjs_Rg([]))
        : a.jsa()
        ? (!this.se[b] && this.Kl[b] && (this.se[b] = new a.nma(this.Kl[b])),
          this.se[b])
        : this.Kl[b];
};
...
gvjs_.translate = function (a, b) {
    a instanceof gvjs_z
        ...
        : ((this.x += Number(a)), typeof b === gvjs_g && (this.y += b));
    return this;
};
...
function gvjs_8g(a, b) {
    gvjs_w(b, function (c, d) {
        ...
        d == gvjs_Jd
            ...
            : "for" == d
            ? (a.htmlFor = c)
            : gvjs_9g.hasOwnProperty(d)
            ? a.setAttribute(gvjs_9g[d], c)
            : gvjs_hf(d, "aria-") || gvjs_hf(d, "data-")
            ? a.setAttribute(d, c)
            : (a[d] = c);
    });
}
        ...
        if (gvjs_ne(f) && !gvjs_ch(f)) {
            a: {
                if (f && typeof f.length == gvjs_g) {
                    if (gvjs_r(f)) {
                        var g =
                            typeof f.item == gvjs_d || typeof f.item == gvjs_l;
                        break a;
                    }
                    if (typeof f === gvjs_d) {
...
function gvjs_lh(a) {
    return gvjs_Raa && void 0 != a.children
        ? a.children
...
function gvjs_mh(a) {
    return void 0 !== a.firstElementChild
        ? a.firstElementChild
        : gvjs_nh(a.firstChild, !0);
}
function gvjs_oh(a) {
    return void 0 !== a.nextElementSibling
        ? a.nextElementSibling
        : gvjs_nh(a.nextSibling, !0);
}
...
function gvjs_th(a, b) {
    ...
    } else gvjs_hh(a), a.appendChild(gvjs_5g(a).createTextNode(String(b)));
}
function gvjs_uh(a) {
...
var gvjs_Taa = { SCRIPT: 1, STYLE: 1, HEAD: 1, IFRAME: 1, OBJECT: 1 },
    gvjs_vh = { IMG: " ", BR: "\n" };
function gvjs_wh(a) {
    ...
    if (!(a.nodeName in gvjs_Taa))
        if (3 == a.nodeType)
            c
                ...
                : b.push(a.nodeValue);
        else if (a.nodeName in gvjs_vh) b.push(gvjs_vh[a.nodeName]);
        else for (a = a.firstChild; a; ) gvjs_xh(a, b, c), (a = a.nextSibling);
}
...
gvjs_.translate = function (a, b) {
    a instanceof gvjs_z
        ...
        : ((this.left += a),
          (this.right += a),
          typeof b === gvjs_g && ((this.top += b), (this.bottom += b)));
    return this;
};
gvjs_.scale = function (a, b) {
...
function gvjs_C(a, b, c) {
    if (typeof b === gvjs_l) (b = gvjs_Ah(a, b)) && (a.style[b] = c);
    else
        for (var d in b) {
            c = a;
            var e = b[d],
...
var gvjs_Lh = { thin: 2, medium: 4, thick: 6 };
...
function gvjs_Qh(a) {
    var b = gvjs_Oh();
    if (!a || !b.Qo(a)) throw Error(gvjs_za);
    return a;
}
var gvjs_D = { rV: "google-visualization-errors" };
gvjs_D.s6 = gvjs_D.rV + "-";
gvjs_D.v6 = gvjs_D.rV + ":";
...
gvjs_D.qja =
    "font-size: 1.1em; color: #00c; font-weight: bold; cursor: pointer; padding-left: 10px; color: black;text-align: right; vertical-align: top;";
var gvjs_Rh = 0;
function gvjs_Sh(a, b, c, d) {
    if (!gvjs_Th(a)) throw Error(gvjs_D.r6 + ". message: " + b);
    d = gvjs_Uh(b, c, d);
    ...
    var f = null != d.showInTooltip ? !!d.showInTooltip : !0,
        g =
            (d.type === gvjs_Wd ? gvjs_Wd : gvjs_Rb) === gvjs_Rb
                ? gvjs_D.tia
                : gvjs_D.Qja;
    g += d.style ? d.style : "";
    var h = !!d.removable;
    b = gvjs_Oh();
    e = b.J(gvjs_6a, { style: g }, b.createTextNode(e));
    g = "" + gvjs_D.s6 + gvjs_Rh++;
    var k = b.J(gvjs_b, { id: g, style: gvjs_D.Sja }, e);
    c &&
        (f
            ? (e.title = c)
            : ((c = b.J(gvjs_6a, {}, b.createTextNode(c))),
              b.appendChild(k, b.J(gvjs_b, { style: "padding: 2px" }, c))));
    h &&
        ((c = b.J(gvjs_6a, { style: gvjs_D.qja }, b.createTextNode("\u00d7"))),
...
gvjs_D.removeAll = function (a) {
    gvjs_Yh(a);
    if ((a = gvjs_Zh(a, !1))) (a.style.display = gvjs_f), gvjs_hh(a);
};
gvjs_D.yva = function (a) {
    a = gvjs_Ph().getElementById(a);
    return null != a && gvjs__h(a) ? (gvjs_Vh(a), !0) : !1;
};
...
function gvjs__h(a) {
    return gvjs_ch(a) &&
        a.id &&
        gvjs_hf(a.id, gvjs_D.s6) &&
        (a = a.parentNode) &&
        a.id &&
        gvjs_hf(a.id, gvjs_D.mV) &&
        a.parentNode
        ? !0
        : !1;
}
...
function gvjs_Uh(a, b, c) {
    ...
    d = gvjs_kf(d);
    e = gvjs_kf(e || "");
    return { errorMessage: d, detailedMessage: e, options: c };
}
gvjs_D.SDa = gvjs_Uh;
function gvjs_Th(a) {
...
function gvjs_Yh(a, b) {
    if (!gvjs_Th(a)) throw Error((void 0 === b ? "" : b) || gvjs_D.r6);
}
gvjs_D.Vya = gvjs_Yh;
function gvjs_Zh(a, b) {
    for (
        var c = a.childNodes, d = null, e = gvjs_Oh(), f = 0;
        f < c.length;
        f++
    ) {
        var g = c[f];
    ...
    !d &&
        ...
        (d = e.J(
            gvjs_b,
            { id: d, style: "display: none; padding-top: 2px" },
            null
        )));
...
gvjs_F.prototype.pa = function () {
    this.xf || ((this.xf = !0), this.M());
};
gvjs_F.prototype.M = function () {
    if (this.Wz) for (; this.Wz.length; ) this.Wz.shift()();
};
...
var gvjs_2h = "PointerEvent" in gvjs_p,
    gvjs_3h =
        "MSPointerEvent" in gvjs_p &&
        !(!gvjs_p.navigator || !gvjs_p.navigator.msPointerEnabled),
    gvjs_Uaa = (function () {
        if (!gvjs_p.addEventListener || !Object.defineProperty) return !1;
        var a = !1,
...
var gvjs_Vaa = { 2: "touch", 3: "pen", 4: "mouse" };
gvjs_5h.prototype.init = function (a, b) {
    ...
    (b = a.relatedTarget)
        ? gvjs_sg && (gvjs_og(b, gvjs_od) || (b = null))
        : c == gvjs_ld
        ? (b = a.fromElement)
        : c == gvjs_kd && (b = a.toElement);
    ...
    d
        ...
        : ((this.offsetX =
              gvjs_tg || void 0 !== a.offsetX ? a.offsetX : a.layerX),
          (this.offsetY =
              gvjs_tg || void 0 !== a.offsetY ? a.offsetY : a.layerY),
    ...
    this.pointerType =
        typeof a.pointerType === gvjs_l
            ? a.pointerType
            : gvjs_Vaa[a.pointerType] || "";
    this.state = a.state;
    this.$i = a;
...
gvjs_.add = function (a, b, c, d, e) {
    var f = a.toString();
    a = this.Rh[f];
    a || ((a = this.Rh[f] = []), this.ZL++);
    var g = gvjs_$h(a, b, d, e);
    -1 < g
        ? ((b = a[g]), c || (b.wN = !1))
        : ((b = new gvjs_Xaa(b, this.src, f, !!d, e)), (b.wN = c), a.push(b));
    return b;
};
gvjs_.remove = function (a, b, c, d) {
    a = a.toString();
    if (!(a in this.Rh)) return !1;
    var e = this.Rh[a];
    b = gvjs_$h(e, b, c, d);
    return -1 < b
        ? (gvjs_8h(e[b]),
          gvjs_Je(e, b),
          0 == e.length && (delete this.Rh[a], this.ZL--),
          !0)
        : !1;
};
function gvjs_ai(a, b) {
    var c = b.type;
    if (!(c in a.Rh)) return !1;
    var d = gvjs_Ie(a.Rh[c], b);
    d && (gvjs_8h(b), 0 == a.Rh[c].length && (delete a.Rh[c], a.ZL--));
    return d;
}
...
function gvjs_G(a, b, c, d, e) {
    if (d && d.once) return gvjs_ei(a, b, c, d, e);
    if (Array.isArray(b)) {
        for (var f = 0; f < b.length; f++) gvjs_G(a, b[f], c, d, e);
        return null;
    }
    c = gvjs_fi(c);
    return gvjs_7h(a)
        ? a.o(b, c, gvjs_r(d) ? !!d.capture : !!d, e)
        : gvjs_gi(a, b, c, !1, d, e);
}
function gvjs_gi(a, b, c, d, e, f) {
    ...
    else if (a.attachEvent) a.attachEvent(gvjs_ii(b.toString()), d);
...
function gvjs_ei(a, b, c, d, e) {
    if (Array.isArray(b)) {
        for (var f = 0; f < b.length; f++) gvjs_ei(a, b[f], c, d, e);
        return null;
    }
    c = gvjs_fi(c);
    return gvjs_7h(a)
        ? a.vD(b, c, gvjs_r(d) ? !!d.capture : !!d, e)
        : gvjs_gi(a, b, c, !0, d, e);
}
function gvjs_ji(a, b, c, d, e) {
    if (Array.isArray(b))
        for (var f = 0; f < b.length; f++) gvjs_ji(a, b[f], c, d, e);
    else
        (d = gvjs_r(d) ? !!d.capture : !!d),
            (c = gvjs_fi(c)),
            gvjs_7h(a)
                ? a.Ab(b, c, d, e)
                : a && (a = gvjs_hi(a)) && (b = a.uI(b, c, d, e)) && gvjs_ki(b);
}
function gvjs_ki(a) {
    if (typeof a === gvjs_g || !a || a.An) return !1;
    var b = a.src;
    if (gvjs_7h(b)) return gvjs_ai(b.Jl, a);
    var c = a.type,
        d = a.pS;
    b.removeEventListener
        ? b.removeEventListener(c, d, a.capture)
        : b.detachEvent
        ? b.detachEvent(gvjs_ii(c), d)
        : b.addListener && b.removeListener && b.removeListener(d);
    gvjs_di--;
    (c = gvjs_hi(b))
        ? (gvjs_ai(c, a), 0 == c.ZL && ((c.src = null), (b[gvjs_bi] = null)))
        : gvjs_8h(a);
    return !0;
}
function gvjs_li(a) {
    if (!a) return 0;
    if (gvjs_7h(a)) return a.Jl ? a.Jl.removeAll(void 0) : 0;
    a = gvjs_hi(a);
    if (!a) return 0;
    var b = 0,
        c;
...
gvjs_.dispatchEvent = function (a) {
    var b,
        c = this.GC();
    if (c) for (b = []; c; c = c.GC()) b.push(c);
    c = this.cka;
    var d = a.type || a;
    if (typeof a === gvjs_l) a = new gvjs_1h(a, c);
    else if (a instanceof gvjs_1h) a.target = a.target || c;
    else {
        var e = a;
        a = new gvjs_1h(d, c);
        gvjs_2e(a, e);
    ...
    if (b)
        for (f = 0; !a.CK && f < b.length; f++)
            (g = a.currentTarget = b[f]), (e = gvjs_ni(g, d, !1, a) && e);
    return e;
};
gvjs_.M = function () {
...
function gvjs_ui(a) {
    return (a = a && typeof a.getKey === gvjs_d && a.getKey())
        ? gvjs_ki(a)
        : !1;
}
function gvjs_vi(a) {
...
function gvjs_pi(a) {
    ...
    null != b ? (a = b) : ((b = new gvjs_H()), (a = a.__eventTarget = b));
    return a;
}
function gvjs_qi(a) {
    return function (b) {
...
function gvjs_xi(a) {
    return a.lC
        ? (a.lC.parentNode !== a.container && a.container.appendChild(a.lC),
          a.lC)
        : a.container;
}
...
function gvjs_yi(a, b, c, d) {
    ...
    e = (0, gvjs_D.Sc)(e, b, null, c);
    (null == d || d) &&
        gvjs_I(a.visualization, gvjs_Rb, {
            id: e,
            message: b,
            detailedMessage: "",
            options: c,
...
gvjs_Ai.prototype.getStringValue = function (a, b) {
    ...
    if (c !== gvjs_l)
        throw Error(
            gvjs_wa + b + " must be of type string, but is " + (c + ".")
        );
...
function gvjs_Mi(a) {
    ...
    if (Array.isArray(a)) return gvjs_v(a, gvjs_Mi);
    if (gvjs_r(a))
        for (b in a)
...
function gvjs_Ri(a, b, c) {
    typeof a === gvjs_g
        ? ((this.date = gvjs_Si(a, b || 0, c || 1)), gvjs_Ti(this, c || 1))
        : gvjs_r(a)
        ? ((this.date = gvjs_Si(a.getFullYear(), a.getMonth(), a.getDate())),
          gvjs_Ti(this, a.getDate()))
        : ((this.date = new Date(gvjs_se())),
          (a = this.date.getDate()),
...
gvjs_.TA = function (a) {
    return (
        [
            this.getFullYear(),
            gvjs_fg(this.getMonth() + 1, 2),
            gvjs_fg(this.getDate(), 2),
        ].join(a ? "-" : "") + ""
    );
};
gvjs_.equals = function (a) {
...
gvjs_.getDaylightAdjustment = function (a) {
    ...
    for (var b = 0; b < this.YA.length && a >= this.YA[b]; ) b += 2;
            ...
            if (d) {
                ...
                0 == c &&
                    ("''" == e
                        ...
                        : ((e = e.substring(
                              1,
                              "'" == d[1] ? e.length - 1 : e.length
                          )),
                          (e = e.replace(/''/g, "'"))));
                this.iS.push({ text: e, type: c });
                break;
            }
        }
...
gvjs_Xi.prototype.format = function (a, b) {
    ...
    for (var f = 0; f < this.iS.length; ++f) {
        ...
        1 == this.iS[f].type
            ? c.push(gvjs_1aa(this, g, a, d, e, b))
            : c.push(g);
    }
    return c.join("");
};
gvjs_Xi.prototype.aN = function (a) {
    if (4 > a) var b = this.Ie.DATEFORMATS[a];
    else if (8 > a) b = this.Ie.TIMEFORMATS[a - 4];
    else if (12 > a)
...
function gvjs__i(a, b) {
    ...
    if (void 0 !== a.Tja) {
        for (var c = [], d = 0; d < b.length; d++) {
            ...
            c.push(
                48 <= e && 57 >= e
                    ? String.fromCharCode(a.Tja + e - 48)
                    : b.charAt(d)
            );
        }
        b = c.join("");
...
function gvjs_1aa(a, b, c, d, e, f) {
    ...
    switch (b.charAt(0)) {
        ...
        case "M":
            ...
            return g;
        case "k":
            return gvjs_0i(e), gvjs__i(a, gvjs_fg(gvjs_Zi(e) || 24, g));
        case "S":
            return gvjs__i(
                a,
        ...
        case "h":
            return gvjs_0i(e), gvjs__i(a, gvjs_fg(gvjs_Zi(e) % 12 || 12, g));
        case "K":
            return gvjs_0i(e), gvjs__i(a, gvjs_fg(gvjs_Zi(e) % 12, g));
        case "H":
            return gvjs_0i(e), gvjs__i(a, gvjs_fg(gvjs_Zi(e), g));
        case "c":
        ...
        case "m":
            return gvjs_0i(e), gvjs__i(a, gvjs_fg(e.getMinutes(), g));
        case "s":
            return gvjs_0i(e), gvjs__i(a, gvjs_fg(e.getSeconds(), g));
        case "v":
            return (g = f || gvjs_Vi(c.getTimezoneOffset())), g.getTimeZoneId();
        case "V":
            return (
                (a = f || gvjs_Vi(c.getTimezoneOffset())),
                2 >= g
                    ? (g = a.getTimeZoneId())
                    : ((g = a),
                      (g = g.isDaylightTime(c)
                          ? void 0 !== g.ix.qia
                              ? g.ix.qia
                              : g.ix.DST_GENERIC_LOCATION
                          : void 0 !== g.ix.E6
                          ? g.ix.E6
                          : g.ix.STD_GENERIC_LOCATION)),
                g
            );
        case "w":
            return (
        ...
        case "Z":
            return (
                (b = f || gvjs_Vi(c.getTimezoneOffset())),
                4 > g
                    ? b.getRFCTimeZoneString(c)
                    : gvjs__i(a, b.getGMTString(c))
            );
        default:
            return "";
    }
...
var gvjs_4i =
    "StopIteration" in gvjs_p
        ? gvjs_p.StopIteration
...
gvjs_.XB = function (a) {
    for (var b = 0; b < this.ad.length; b++) {
        var c = this.ad[b];
        if (gvjs_cj(this.qa, c) && this.qa[c] == a) return !0;
    }
    return !1;
};
gvjs_.equals = function (a, b) {
    if (this === a) return !0;
    if (this.size != a.Cd()) return !1;
    b = b || gvjs_3aa;
    gvjs_bj(this);
...
function gvjs_bj(a) {
    ...
    if (a.size != a.ad.length) {
        ...
        for (c = b = 0; b < a.ad.length; )
            (d = a.ad[b]), gvjs_cj(e, d) || ((a.ad[c++] = d), (e[d] = 1)), b++;
        a.ad.length = c;
    }
}
...
gvjs_.set = function (a, b) {
    gvjs_cj(this.qa, a) || (this.cu(this.size + 1), this.ad.push(a), this.pM++);
    this.qa[a] = b;
};
...
gvjs_.xk = function (a) {
    ...
    e.rg = function () {
        ...
        if (b >= d.ad.length) throw gvjs_4i;
        var f = d.ad[b++];
        return a ? f : d.qa[f];
    };
    e.next = e.rg.bind(e);
...
function gvjs_dj(a) {
    return a.Cd && typeof a.Cd == gvjs_d
        ? a.Cd()
        : gvjs_ne(a) || typeof a === gvjs_l
        ? a.length
        : gvjs_We(a);
}
function gvjs_ej(a) {
    if (a.ob && typeof a.ob == gvjs_d) return a.ob();
    if (
        ("undefined" !== typeof Map && a instanceof Map) ||
        ("undefined" !== typeof Set && a instanceof Set)
    )
        return Array.from(a.values());
    if (typeof a === gvjs_l) return a.split("");
    if (gvjs_ne(a)) {
...
function gvjs_fj(a) {
    if (a.cj && typeof a.cj == gvjs_d) return a.cj();
...
function gvjs_gj(a, b, c) {
    if (a.forEach && typeof a.forEach == gvjs_d) a.forEach(b, c);
    else if (gvjs_ne(a) || typeof a === gvjs_l)
        Array.prototype.forEach.call(a, b, c);
    else
        for (
            var d = gvjs_fj(a), e = gvjs_ej(a), f = e.length, g = 0;
            g < f;
            g++
        )
...
function gvjs_4aa(a, b) {
    if (typeof a.every == gvjs_d) return a.every(b, void 0);
    if (gvjs_ne(a) || typeof a === gvjs_l)
...
gvjs_.kD = function (a) {
    var b = gvjs_dj(a);
    if (this.Cd() > b) return !1;
    !(a instanceof gvjs_hj) && 5 < b && (a = new gvjs_hj(a));
    return gvjs_4aa(this, function (c) {
        var d = a;
        return d.contains && typeof d.contains == gvjs_d
            ? d.contains(c)
            : d.XB && typeof d.XB == gvjs_d
            ? d.XB(c)
            : gvjs_ne(d) || typeof d === gvjs_l
            ? gvjs_He(d, c)
            : gvjs__e(d, c);
    });
};
...
function gvjs_mj(a, b) {
    ...
    if (2 === arguments.length) {
        c = arguments[1];
        if (!gvjs_lj(c)) return a;
        for (var d in c)
            if (Array.isArray(c[d])) a[d] = gvjs_Le(c[d]);
            else if (gvjs_lj(a[d])) a[d] = gvjs_mj(a[d], c[d]);
            else if (gvjs_lj(c[d])) a[d] = gvjs_mj({}, c[d]);
...
function gvjs_qj(a) {
    ...
    if (gvjs_rj.test(c)) return (b.hex = gvjs_sj(c)), (b.type = "hex"), b;
    c = gvjs_tj(a);
    if (c.length) return (b.hex = gvjs_uj(c)), (b.type = "rgb"), b;
...
var gvjs_5aa = /#(.)(.)(.)/;
function gvjs_sj(a) {
    if (!gvjs_rj.test(a)) throw Error("'" + a + "' is not a valid hex color");
...
function gvjs_Jj(a) {
    if (null == a) return null;
    if (typeof a === gvjs_zb) return a;
    a = String(a);
    return "1" === a || a.toLowerCase() === gvjs_Rd
        ? !0
        : "0" === a || a.toLowerCase() === gvjs_Sb
        ? !1
        : null;
}
...
function gvjs_Lj(a) {
    return null == a
        ? null
        : typeof a === gvjs_g || typeof a === gvjs_l || typeof a === gvjs_zb
        ? a
        : null;
}
gvjs_.kt = function (a) {
...
function gvjs_Mj(a) {
    return null == a
        ? null
        : Array.isArray(a)
        ? gvjs_De(gvjs_v(a, gvjs_Kj), function (b) {
              return null != b;
          })
        : null;
}
...
function gvjs_Qj(a, b) {
    if (null == a) return null;
    if ("" === a) return gvjs_f;
    if (typeof a === gvjs_h) return a.color || a.lighter || a.darker ? a : null;
    a = gvjs_Hj(a);
    if (Array.isArray(b) && gvjs_He(b, a)) return a;
    try {
        return gvjs_yj(a);
    } catch (c) {
        return null;
...
function gvjs_Rj(a, b) {
    ...
    null == c &&
        ...
        null != a &&
            gvjs_if(a) &&
            ((c = a.slice(0, -1)), (c = (b * Number(c)) / 100)));
...
gvjs_.init = function (a) {
    a = new gvjs_Aj([a || {}, { formatType: gvjs_Gd, valueType: gvjs_Mb }]);
...
gvjs_.pm = gvjs_n(16);
gvjs_.cP = function (a) {
    if (gvjs_Uj) return gvjs_Uj.call(this, a, this.pattern);
...
var gvjs_Uj = void 0,
    gvjs_Vj = gvjs_2i,
    gvjs_8aa = { gAa: gvjs_Tb, EAa: "long", JAa: gvjs_dd, SHORT: gvjs_Gd };
var gvjs_Wj = {
        q6: {
            1e3: { other: "0K" },
            1e4: { other: "00K" },
...
gvjs_.setMinimumFractionDigits = function (a) {
    if (0 < this.hu && 0 < a) throw Error(gvjs_ta);
    this.Ht = a;
    return this;
};
...
gvjs_.setSignificantDigits = function (a) {
    if (0 < this.Ht && 0 <= a) throw Error(gvjs_ta);
    this.hu = a;
    return this;
};
...
gvjs_.Zr = function (a) {
    ...
    g = e + f + g;
    this.Qq = 0 <= d ? g - d : 0;
    0 <= d && ((this.Ht = e + f - d), 0 > this.Ht && (this.Ht = 0));
    this.Zo = (0 <= d ? d : g) - e;
    this.NU &&
        ((this.MJ = e + this.Zo),
    ...
    b[0] < a.length && ";" == a.charAt(b[0])
        ? (b[0]++,
          ...
          (b[0] += c),
          (this.QD = gvjs_5j(this, a, b)))
        : ((this.sw += this.hA), (this.QD += this.wK));
};
gvjs_.aN = function (a) {
    switch (a) {
        case 1:
...
gvjs_.parse = function (a, b) {
    ...
    c &&
        d &&
        (this.hA.length > this.sw.length
            ? (d = !1)
            : this.hA.length < this.sw.length && (c = !1));
    ...
    if (c) {
        if (a.indexOf(this.wK, b[0]) != b[0]) return NaN;
        b[0] += this.wK.length;
    } else if (d) {
        if (a.indexOf(this.QD, b[0]) != b[0]) return NaN;
        b[0] += this.QD.length;
    }
    return d ? -e : e;
};
gvjs_.format = function (a) {
    if (isNaN(a)) return gvjs_2j(this).cja;
    var b = [];
    var c = null === this.kN ? a : this.kN;
    if (0 == this.eH) c = gvjs_8j;
    else {
        c = Math.abs(c);
    ...
    (d = 0 > a || (0 == a && 0 > 1 / a))
        ? c.p1
            ? b.push(c.p1)
            : (b.push(c.prefix), b.push(this.sw))
        : (b.push(c.prefix), b.push(this.hA));
    if (isFinite(a))
        if (((a = a * (d ? -1 : 1) * this.Jf), this.NU)) {
            var e = a;
            if (0 == e) gvjs_ck(this, e, this.Zo, b), gvjs_dk(this, 0, b);
            else {
                var f = Math.floor(Math.log(e) / Math.log(10) + 2e-15);
                e = gvjs_bk(e, -f);
                var g = this.Zo;
                1 < this.MJ && this.MJ > this.Zo
                    ? ((g = f % this.MJ),
                      0 > g && (g = this.MJ + g),
                      (e = gvjs_bk(e, g)),
                      (f -= g),
                    ...
                    : 1 > this.Zo
                    ? (f++, (e = gvjs_bk(e, -1)))
                    : ((f -= this.Zo - 1), (e = gvjs_bk(e, this.Zo - 1)));
                gvjs_ck(this, e, g, b);
                gvjs_dk(this, f, b);
            }
        } else gvjs_ck(this, a, this.Zo, b);
    else b.push(gvjs_2j(this).sV);
    d
        ? c.q1
            ? b.push(c.q1)
            : (isFinite(a) && b.push(c.suffix), b.push(this.QD))
        : (isFinite(a) && b.push(c.suffix), b.push(this.wK));
    return b.join("");
};
function gvjs_ak(a, b) {
    ...
    c = Math.round(c);
    isFinite(c)
        ? ((b = Math.floor(gvjs_bk(c, -a.Qq))),
          (a = Math.floor(c - gvjs_bk(b, a.Qq))))
        : (a = 0);
    return { wba: b, qoa: a };
}
function gvjs_ck(a, b, c, d) {
    if (a.Ht > a.Qq) throw Error("Min value must be less than max value");
    d || (d = []);
    b = gvjs_ak(a, b);
    var e = b.wba,
        f = b.qoa,
    ...
    var k = "";
    for (g = e; 1e20 < g; ) (k = "0" + k), (g = Math.round(gvjs_bk(g, -1)));
    k = g + k;
    ...
    if (0 < e || 0 < c) {
        ...
        if (2 <= a.Yy.length) for (c = 1; c < a.Yy.length; c++) n += a.Yy[c];
        c = m - n;
        if (0 < c) {
            e = a.Yy;
            n = m = 0;
            for (
                var p, q = gvjs_2j(a).GROUP_SEP, r = k.length, t = 0;
                t < r;
                t++
            )
                if (
                    (d.push(String.fromCharCode(g + 1 * Number(k.charAt(t)))),
                    1 < r - t)
                )
                    if (((p = e[n]), t < c)) {
                        var u = c - t;
            ...
            for (m = k.length - 1; 0 <= m && 0 < p; m--) {
                ...
                for (r = 0; r < n && 0 <= p - r - 1; r++)
                    q.push(
                        String.fromCharCode(g + 1 * Number(c.charAt(p - r - 1)))
                    );
                p -= n;
                0 < p && q.push(e);
            }
    ...
    h = f.split("e+");
    2 == h.length &&
        ((f = String(gvjs_ek(parseFloat(h[0]), a.hu, 1))),
        (f = f.replace(".", "")),
...
function gvjs_dk(a, b, c) {
    c.push(gvjs_2j(a).t6);
    0 > b ? ((b = -b), c.push(gvjs_2j(a).w6)) : a.jha && c.push(gvjs_2j(a).nja);
    b = "" + b;
    for (var d = gvjs_2j(a).BV, e = b.length; e < a.tR; e++) c.push(d);
    c.push(b);
}
        ...
        if ("'" == g)
            ...
            switch (g) {
                ...
                case "\u00a4":
                    ...
                    break;
                case "%":
                    if (!a.Pz && 1 != a.Jf) throw Error(gvjs_gb);
                    if (a.Pz && 100 != a.Jf) throw Error(gvjs_Qa);
                    a.Jf = 100;
                    a.Pz = !1;
                    d += gvjs_2j(a).PERCENT;
                    break;
                case "\u2030":
                    if (!a.Pz && 1 != a.Jf) throw Error(gvjs_gb);
                    if (a.Pz && 1e3 != a.Jf) throw Error(gvjs_Qa);
                    a.Jf = 1e3;
                    a.Pz = !1;
                    d += gvjs_2j(a).y6;
                    break;
...
var gvjs_8j = { divisorBase: 0, p1: "", q1: "", prefix: "", suffix: "" };
function gvjs_9j(a, b) {
    a = 1 == a.eH ? gvjs_Xj.q6 : gvjs_Xj.jia;
    null == a && (a = gvjs_Xj.q6);
    if (3 > b) return gvjs_8j;
    b = Math.min(14, b);
    var c = a[gvjs_bk(1, b)];
    for (--b; !c && 3 <= b; ) (c = a[gvjs_bk(1, b)]), b--;
    if (!c) return gvjs_8j;
    c = c.other;
    var d = (a = ""),
        e = c.indexOf(";");
...
function gvjs_gk(a) {
    ...
    a &&
        typeof a.fractionDigits === gvjs_g &&
        isNaN(a.fractionDigits) &&
        (this.Ey = NaN);
    ...
    if (a.W(b) === gvjs_g)
        for (var c = 0; c < a.ca(); c++) {
            ...
            if (null != d) {
                ...
                a.Nw(c, b, e);
                0 > d &&
                    !gvjs_jf(gvjs_gg(this.o1)) &&
                    a.setProperty(c, b, gvjs_Jd, gvjs_Eb + this.o1 + ";");
            }
        }
};
gvjs_.Jo = function (a) {
...
gvjs_.cP = function (a) {
    if (gvjs_kk)
        return (
            (a = gvjs_kk.call(this, a / this.scaleFactor, this.pattern)),
    ...
    if (null !== this.pattern) {
        ...
        this.gd = c;
        null != this.n4 &&
            (c.setSignificantDigits(this.n4),
            c.setMaximumFractionDigits(this.n4));
        b = c.format(b);
        b = this.prefix + b + this.suffix;
        gvjs_3j = a;
    } else {
        if (isNaN(this.Ey)) return String(a);
        ...
        if (3 < c.length && this.MZ)
            for (
                e = c.length % 3,
                    0 < e &&
                        (b.push(c.substring(0, e), this.MZ),
                        (c = c.substring(e)));
                3 < c.length;

            )
                b.push(c.substring(0, 3), this.MZ), (c = c.substring(3));
        b.push(c);
        0 < this.Ey &&
            (b.push(this.Cma),
...
gvjs_.equals = function (a) {
    return this === a
        ? !0
        : a instanceof gvjs_ok && !!a && this.x == a.x && this.y == a.y;
}; /*
...
function gvjs_tk(a) {
    ...
    if (null == b || typeof b !== gvjs_g) b = 1;
    b = { pattern: 1 < b ? gvjs_Ia : 1 === b ? gvjs_Ja : gvjs_Ka };
    a && gvjs_2e(b, a);
...
function gvjs_uk(a) {
    var b = {};
    if (gvjs_me(a) !== gvjs_h || gvjs_oe(a)) b.v = null != a ? a : null;
    else {
        b.v = "undefined" === typeof a.v ? null : a.v;
        if (null != a.f)
            if (typeof a.f === gvjs_l) b.f = a.f;
            else
                throw Error(
                    "Formatted value ('f'), if specified, must be a string."
                );
        if (null != a.p)
            if (typeof a.p === gvjs_h) b.p = a.p;
            else
                throw Error(
...
function gvjs_$aa(a, b, c) {
    if (typeof b === gvjs_d) return b(a, c);
    for (var d = 0; d < b.length; d++) {
        var e = b[d],
            f = a.jf(e.column),
            g = a.getValue(c, f),
            h = a.W(f);
        if (gvjs_Vd in e) {
            if (0 !== gvjs_vk(h, g, e.value)) return !1;
        } else if (null != e.minValue || null != e.maxValue)
            if (
                null == g ||
                (null != e.minValue && 0 > gvjs_vk(h, g, e.minValue)) ||
                (null != e.maxValue && 0 < gvjs_vk(h, g, e.maxValue))
            )
                return !1;
        e = e.test;
        if (null != e && typeof e === gvjs_d && !e(g, c, f, a)) return !1;
    }
    return !0;
}
function gvjs_wk(a, b) {
    if (typeof b !== gvjs_d) {
        ...
        for (
            var c = [], d = 0, e = gvjs_8d(b), f = e.next();
            !f.done;
            f = e.next()
        ) {
            f = f.value;
            if (typeof f !== gvjs_h || !(gvjs_Fb in f)) {
                if (!(gvjs_Vd in f || gvjs_ed in f || gvjs_cd in f))
                    throw Error(
                        gvjs_Gb +
                            d +
                            '] must have properties "column" and one of "value", "minValue" or "maxValue"'
                    );
                if (gvjs_Vd in f && (gvjs_ed in f || gvjs_cd in f))
                    throw Error(
                        gvjs_Gb +
    ...
    c = [];
    d = a.ca();
    for (e = 0; e < d; e++) gvjs_$aa(a, b, e) && c.push(e);
    return c;
}
...
function gvjs_Ak(a, b, c) {
    ...
    var e = [];
    if (typeof c === gvjs_d) d = c;
    else if (typeof c === gvjs_g || typeof c === gvjs_l)
        gvjs_xk(a, c), (e = [{ column: a.jf(c) }]);
    else if (gvjs_r(c))
        if (Array.isArray(c)) {
            if (0 === c.length)
                throw Error(
            ...
            for (var f = [], g = 0, h = 0; h < c.length; h++) {
                ...
                if (typeof g === gvjs_g || typeof g === gvjs_l)
                    gvjs_xk(a, g), (g = a.jf(g)), e.push({ column: g });
                else if (gvjs_r(g)) {
                    var k = g;
                    ...
                    throw Error(
                        "sortColumns is an array, but not composed of only objects or numbers."
                    );
                if (g in f)
                    throw Error(
                        "Column index " + g + " is duplicated in sortColumns."
                    );
                f[g] = !0;
            }
        } else gvjs_zk(a, c, "sortColumns"), (e = [c]);
    return d;
}
...
function gvjs_Bk(a, b) {
    ...
    for (var c = [], d = a.ca(), e = 0; e < d; e++) c.push(e);
    gvjs_Se(c, b);
    return c;
}
...
function gvjs_xk(a, b) {
    if (typeof b === gvjs_g) gvjs_Dk(a, b);
    else {
        if (typeof b !== gvjs_l)
            throw Error(
                "Column reference " + b + " must be a number or string"
            );
        if (-1 === a.jf(b)) throw Error('Invalid column id "' + b + '"');
    }
}
        ...
        if (Math.floor(b) !== b || 0 > b || b >= a)
            throw Error(
                "Invalid column index " +
                    b +
                    ".  Should be an integer in the range [0-" +
                    (a - 1 + "].")
            );
...
function gvjs_Ek(a, b) {
    ...
    switch (b) {
        case gvjs_g:
            if (c === gvjs_g) return !0;
            break;
        case gvjs_l:
            if (c === gvjs_l) return !0;
            break;
        case gvjs_zb:
            if (c === gvjs_zb) return !0;
            break;
        case gvjs_d:
            if (c === gvjs_d) return !0;
            break;
        case gvjs_Lb:
        case gvjs_Mb:
...
function gvjs_Fk(a, b) {
    ...
    if (null == d) return { min: null, max: null };
    for (f++; f < g; f++)
        (h = a.getValue(f, b)),
            null != h &&
                (0 > gvjs_vk(c, h, d)
...
function gvjs_Gk(a, b) {
    ...
    for (d = 1; d < b.length; d++)
        (e = b[d]), 0 !== gvjs_vk(f, e, a) && c.push(e), (a = e);
    return c;
}
function gvjs_Hk(a, b, c) {
    ...
    switch (b) {
        case gvjs_Od:
            ...
            if (a[2] || a[3]) c += ":ss";
            a[3] && (c += ".SSS");
            c = new gvjs_Tj({ pattern: c });
            a = c.Ob(b);
            break;
        case gvjs_Lb:
            c = new gvjs_Tj({ formatType: gvjs_dd, valueType: gvjs_Lb });
            a = c.Ob(a);
            break;
        case gvjs_Mb:
            c = new gvjs_Tj({ formatType: gvjs_dd, valueType: gvjs_Mb });
            a = c.Ob(a);
            break;
        case gvjs_g:
            c = new gvjs_gk({ pattern: gvjs_Nb });
            a = c.Ob(a);
            break;
        default:
            a = null != a ? String(a) : "";
...
function gvjs_aba(a) {
    switch (a) {
        ...
        case gvjs_Lb:
            return new gvjs_Tj();
        case gvjs_Mb:
            return new gvjs_Tj({ formatType: gvjs_dd, valueType: gvjs_Mb });
        case gvjs_g:
            return new gvjs_gk({ pattern: gvjs_Nb });
        default:
            return new gvjs_nk();
    }
}
function gvjs_Ik(a, b, c) {
    var d = a.W(b);
    if (null == c) c = gvjs_aba(d);
    else if (null == c.Jo(d)) return;
    d = c.Jo(d);
    d = c.dv(d);
...
function gvjs_M(a, b) {
    ...
    if (typeof this.Cv !== gvjs_d)
        throw Error(
            'You called google.visualization.DataTable() without the "new" keyword'
        );
    this.version = "0.5" === b ? "0.5" : "0.6";
    if (null != a) {
        if (typeof a === gvjs_l) a = gvjs_Li(a);
        else
            a: {
                b = a.cols || [];
        ...
        this.Br = a.p || null;
        if (null != a.cols)
            for (b = gvjs_8d(a.cols), c = b.next(); !c.done; c = b.next())
                this.xd(c.value);
        null != a.rows && (this.Wf = a.rows);
    } else (this.bf = []), (this.Wf = []), (this.Br = null);
    this.cache = [];
}
...
gvjs_.Ha = function (a, b, c) {
    ...
    if (d)
        if (null != d.f) e = String(d.f);
            ...
            d = f[b] || {};
            f[b] = d;
            "undefined" !== typeof d.Me
                ? (e = d.Me)
                : ((a = this.getValue(a, b)),
                  null !== a &&
                      ((e = gvjs_Hk(a, this.W(b), c)),
                      null == e && (e = void 0)),
                  (d.Me = e));
        }
...
gvjs_.Wb = function (a, b, c, d, e) {
    ...
    f || ((f = {}), (this.Wf[a].c[b] = f));
    "undefined" !== typeof c &&
        (this.W(b) !== gvjs_g || typeof c !== gvjs_l || isNaN(c)
            ? (gvjs_yk(this, b, c), (f.v = c))
            : (f.v = Number(c)));
...
gvjs_.uba = function (a, b, c, d) {
    a !== this.bf.length && ((this.cache = []), gvjs_Dk(this, a));
    if (typeof b === gvjs_l) {
        var e = b;
        c = c || "";
        d = d || "";
        b = { id: d, label: c, pattern: "", type: e };
    }
    if (!gvjs_r(b))
    ...
    b = Object.assign(Object.assign({}, b), { type: e });
    if ((e = b.role))
        (c = b.p || {}), null == c.role && ((c.role = e), (b.p = c));
    this.bf.splice(a, 0, b);
    this.cq = null;
    for (b = 0; b < this.Wf.length; b++) this.Wf[b].c.splice(a, 0, { v: null });
};
...
gvjs_.G_ = function (a, b) {
    a !== this.Wf.length && ((this.cache = []), gvjs_Ck(this, a));
    ...
    for (var d = 0; d < c.length; d++) {
        var e = c[d],
            f = [];
        if (null === e)
            for (e = 0; e < this.bf.length; e++) f.push({ v: null });
        else if (Array.isArray(e)) {
            if (e.length !== this.bf.length)
                throw Error(
                    "Row " +
                        d +
                        " given with size different than " +
                        this.bf.length +
...
gvjs_.Kp = function (a) {
    if (Array.isArray(a)) return this.Yn([a]);
    if (null == a) return this.Yn(1);
...
gvjs_.Bp = function () {
    var a = { cols: this.bf, rows: this.Wf };
    this.Br && (a.p = this.Br);
...
gvjs_.toJSON = function () {
    for (var a = 0; a < this.bf.length; a++)
        if (this.W(a) === gvjs_d)
            throw Error(
                "Cannot get JSON representation of data table due to function data type at column " +
                    a
            );
...
gvjs_.Hea = function (a, b) {
    if (!(0 >= b)) {
        ...
        this.bf.splice(a, b);
        this.cq = null;
        for (var c = 0; c < this.Wf.length; c++) this.Wf[c].c.splice(a, b);
    }
};
gvjs_.BS = function (a) {
    this.Hea(a, 1);
...
function gvjs_cba(a, b) {
    if (b) {
        ...
        b = a.map(function (d) {
            if (typeof d === gvjs_l) return { label: d };
            if (gvjs_r(d)) return gvjs_x(d);
        ...
        Array.isArray(a)
            ...
            : gvjs_r(a) &&
              ...
              Array.isArray(a.c) &&
              (c = a.c.length);
        for (a = 0; a < c; a++) b.push({ type: void 0 });
    }
    return b;
}
function gvjs_Mk(a, b) {
    ...
    if (0 === a.length) b = new gvjs_M();
        ...
        for (c = c ? 1 : 0; c < a.length; c++) {
            ...
            else if (gvjs_r(f) && gvjs_Ze(f, "c")) (h = f.c), (e = f.p);
            ...
            for (f = 0; f < b.length; f++)
                if (
                    ((g = h[f]),
                    gvjs_r(g) && (gvjs_Ze(g, "v") || gvjs_Ze(g, "f"))
                        ? (g = g.v)
                        : (h[f] = { v: g }),
                    ...
                    var k = null;
                    if (null != g)
                        if (typeof g === gvjs_l) k = gvjs_l;
                        else if (typeof g === gvjs_g) k = gvjs_g;
                        else if (Array.isArray(g)) k = gvjs_Od;
                        else if (typeof g === gvjs_zb) k = gvjs_zb;
                        else if (gvjs_oe(g))
        ...
        for (a = 0; a < b.length; a++)
            (c = b[a]), "date?" === c.type && (c.type = gvjs_Lb);
        b = new gvjs_M({ cols: b, rows: d });
    }
    return b;
}
function gvjs_Nk(a) {
    ...
    for (
        var c = {}, d = 0, e = gvjs_8d(a), f = e.next();
        !f.done;
        f = e.next()
    ) {
        f = gvjs_8d(b(f.value));
    ...
    for (f = a.next(); !f.done; f = a.next())
        for (
            f = f.value, e = [], d.push(e), f = gvjs_8d(b(f)), g = f.next();
            !g.done;
            g = f.next()
        )
            (h = gvjs_8d(g.value)),
...
function gvjs_fba(a) {
    for (var b = [], c = a.Ta.ca(), d = 0; d < c; d++) b.push(d);
    a.ir = b;
    gvjs_Ok(a);
}
gvjs_.Hn = function (a) {
    for (var b = this.Ta, c = gvjs_Ye(gvjs_Pk), d = 0; d < a.length; d++) {
        var e = a[d];
        if (typeof e === gvjs_g || typeof e === gvjs_l) gvjs_xk(b, e);
        else if (gvjs_r(e)) {
...
function gvjs_Qk(a, b, c) {
    if (Array.isArray(b)) {
        if (void 0 !== c)
            throw Error(
                "If the first parameter is an array, no second parameter is expected"
            );
        for (c = 0; c < b.length; c++) gvjs_Ck(a.Ta, b[c]);
        return gvjs_Le(b);
    }
    if (typeof b === gvjs_g) {
        if (typeof c !== gvjs_g)
...
gvjs_.T$ = function () {
    if (this.Fq) {
        for (var a = [], b = this.Ta.ca(), c = 0; c < b; c++) a.push(c);
        return a;
    }
...
gvjs_.ora = function (a) {
    this.Hn(
        gvjs_De(this.columns, function (b) {
            return !gvjs_He(a, b);
        })
    );
    gvjs_Ok(this);
...
gvjs_.qra = function (a, b) {
    ...
    this.Fq && (gvjs_fba(this), (this.Fq = !1));
    this.pp(
        gvjs_De(this.ir, function (d) {
            return !gvjs_He(c, d);
        })
    );
    gvjs_Ok(this);
...
gvjs_.S$ = function (a) {
    for (var b = 0; b < this.columns.length; b++) {
        ...
        if (c === a || (gvjs_r(c) && c.sourceColumn === a)) return b;
    }
    return -1;
};
gvjs_.GZ = function (a) {
...
gvjs_.CP = function (a) {
    gvjs_Dk(this, a);
    a = this.columns[a];
    return typeof a === gvjs_g
        ? a
        : gvjs_r(a) && typeof a.sourceColumn === gvjs_g
        ? a.sourceColumn
        : -1;
};
gvjs_.Ty = function (a) {
    ...
    if (gvjs_r(c)) {
        ...
        if (void 0 !== c) d = c;
            ...
            if (typeof e === gvjs_l) {
                ...
                c = c(this.Ta, a, d);
            } else typeof e === gvjs_d && (c = e.call(null, this.Ta, a));
            c = gvjs_uk(c);
            d = d.type;
            e = c.v;
            if (gvjs_jf(gvjs_gg(d))) throw Error('"type" must be specified');
            if (!gvjs_Ek(e, d)) throw Error(gvjs_jb + e + gvjs_aa + d + ".");
            d = this.yW[b][a] = c;
        }
        d.p = gvjs_r(d.p) ? d.p : {};
    } else if (typeof c === gvjs_g) d = { v: this.Ta.getValue(a, c) };
...
gvjs_.Ha = function (a, b, c) {
    ...
    if (null == d.f) {
        ...
        gvjs_r(e)
            ? ((e = this.W(b)), (d.f = null == d.v ? "" : gvjs_Hk(d.v, e, c)))
            : typeof e === gvjs_g &&
              ((a = this.fj(a)), (d.f = this.Ta.Ha(a, e, c)));
    }
    c = d.f;
...
gvjs_.getProperties = function (a, b) {
    ...
    return c.p
        ? c.p
        : ((a = this.fj(a)), (b = this.CP(b)), this.Ta.getProperties(a, b));
};
...
gvjs_.Gr = function () {
    ...
    for (d = 0; d < b; d++) {
        ...
        } else if (typeof g === gvjs_g) h = (a.cols || [])[g];
        else throw Error(gvjs_Ra);
        e.push(h);
    }
    ...
    for (h = 0; h < c; h++) {
        ...
        for (d = 0; d < b; d++) {
            g = this.columns[d];
            if (gvjs_r(g)) g = { v: this.getValue(h, d) };
            else if (typeof g === gvjs_g) g = l.c[g];
            else throw Error(gvjs_Ra);
            m.push(g);
        }
        l.c = m;
...
var gvjs_Pk = {
    ...
    error: function (a, b, c) {
        var d = c.sourceColumn,
            e = c.magnitude;
        if (typeof d !== gvjs_g || typeof e !== gvjs_g) return null;
        a = a.getValue(b, d);
        return typeof a !== gvjs_g
            ? null
            : c.errorType === gvjs_ud
    ...
    mapFromSource: function (a, b, c) {
        var d = c.sourceColumn;
        c = c.mapping;
        return typeof d === gvjs_g &&
            c &&
            ((a = a.getValue(b, d)), typeof a === gvjs_l)
            ? a in c
                ? c[a]
                : null
            : null;
...
function gvjs_Sk(a) {
    ...
    gvjs_Uk(this.errors);
    this.DY !== gvjs_Rb &&
        ((this.m4 = a.sig), (this.Ta = new gvjs_M(a.table, this.Lva)));
}
function gvjs_Uk(a) {
    for (var b = 0; b < a.length; b++) {
        var c = a[b].detailed_message;
        c &&
            (a[b].detailed_message = c
                ? c.match(gvjs_gba) && !c.match(gvjs_hba)
                    ? c
                    : c
                          .replace(/&/g, "&amp;")
                          .replace(/</g, gvjs_fa)
...
function gvjs_Vk(a) {
    for (var b = 0; b < a.errors.length; b++)
        if ("not_modified" === a.errors[b].reason) return !0;
    for (b = 0; b < a.warnings.length; b++)
        if ("not_modified" === a.warnings[b].reason) return !0;
    return !1;
}
gvjs_.mb = function () {
    return this.Ta;
...
function gvjs_Wk(a, b) {
    return a.Xk() && a.errors && a.errors[0] && a.errors[0][b]
        ? a.errors[0][b]
        : a.j_() && a.warnings && a.warnings[0] && a.warnings[0][b]
        ? a.warnings[0][b]
        : null;
}
gvjs_.Q$ = function () {
...
function gvjs_Xk(a, b) {
    (0, gvjs_D.Vya)(a);
    if (!b) throw Error(gvjs_D.v6 + " response is null");
    if (b.Xk() || b.j_()) {
        var c = b.Q$(),
            d = !0;
        b.Xk() &&
            (d = !(
                gvjs_He(c, "user_not_authenticated") ||
                gvjs_He(c, "invalid_query")
            ));
        c = b.sP();
        var e = b.nZ();
        d = { showInTooltip: d };
        ...
        a = { container: a, message: c, Oma: e, options: d };
    } else a = null;
    return null == a
        ? null
        : (0, gvjs_D.Sc)(a.container, a.message, a.Oma, a.options);
}
var gvjs_gba =
...
function gvjs_Zk(a) {
    0 === a.$m.length && ((a.$m = a.Np), a.$m.reverse(), (a.Np = []));
}
...
gvjs__k.prototype.put = function (a) {
    this.Hva(a);
    this.SR < this.Psa && (this.SR++, (a.next = this.pc), (this.pc = a));
};
var gvjs_0k;
function gvjs_jba() {
...
function gvjs_kba() {
    if (gvjs_p.Promise && gvjs_p.Promise.resolve) {
        ...
        gvjs_6k = function () {
            var b = gvjs_9k;
            typeof gvjs_p.setImmediate !== gvjs_d ||
            (gvjs_p.Window &&
                gvjs_p.Window.prototype &&
                !gvjs_Uf(gvjs_Ca) &&
                gvjs_p.Window.prototype.setImmediate == gvjs_p.setImmediate)
                ? (gvjs_0k || (gvjs_0k = gvjs_jba()), gvjs_0k(b))
                : gvjs_p.setImmediate(b);
        };
}
var gvjs_7k = !1,
    gvjs_8k = new gvjs_2k();
...
gvjs_al.prototype.then = function (a, b, c) {
    return gvjs_gl(
        this,
        typeof a === gvjs_d ? a : null,
        typeof b === gvjs_d ? b : null,
        c
    );
};
...
function gvjs_il(a, b) {
    if (0 == a.K)
        if (a.qd) {
            ...
            if (c.Pu) {
                for (
                    var d = 0, e = null, f = null, g = c.Pu;
                    g &&
                    (g.ZM || (d++, g.child == a && (e = g), !(e && 1 < d)));
                    g = g.next
                )
                    e || (f = g);
                e &&
    ...
    if (0 == a.K) {
        ...
        a: {
            ...
            if (d instanceof gvjs_al) {
                ...
                var g = !0;
            } else if (gvjs_$k(d)) d.then(e, f, a), (g = !0);
            else {
                if (gvjs_r(d))
                    try {
                        var h = d.then;
...
function gvjs_ml(a) {
    a.CY || ((a.CY = !0), gvjs_5k(a.Xna, a));
}
function gvjs_jl(a) {
    var b = null;
    a.Pu && ((b = a.Pu), (a.Pu = b.next), (b.next = null));
    a.Pu || (a.NB = null);
    return b;
}
gvjs_al.prototype.Xna = function () {
    for (var a; (a = gvjs_jl(this)); ) gvjs_kl(this, a, this.K, this.ik);
    this.CY = !1;
};
function gvjs_kl(a, b, c, d) {
    if (3 == c && b.UD && !b.ZM) for (; a && a.HP; a = a.qd) a.HP = !1;
    if (b.child) (b.child.qd = null), gvjs_nl(b, c, d);
    else
        try {
...
function gvjs_pl(a, b, c) {
    if (typeof a === gvjs_d) c && (a = gvjs_s(a, c));
    else if (a && typeof a.handleEvent == gvjs_d) a = gvjs_s(a.handleEvent, a);
...
gvjs_.cancel = function (a) {
    if (this.sC) this.ik instanceof gvjs_rl && this.ik.cancel();
    else {
        if (this.qd) {
            var b = this.qd;
            delete this.qd;
            a ? b.cancel(a) : (b.pW--, 0 >= b.pW && b.cancel());
        }
        this.zda ? this.zda.call(this.p9, this) : (this.o4 = !0);
        this.sC || ((a = new gvjs_sl(this)), this.Wp(), gvjs_tl(this, !1, a));
    }
};
...
gvjs_.Wp = function () {
    if (this.sC) {
        if (!this.o4) throw new gvjs_vl(this);
        this.o4 = !1;
    }
};
gvjs_.yN = gvjs_n(21);
...
function gvjs_ul(a) {
    if (a.KU && a.sC && gvjs_xl(a)) {
        var b = a.KU,
            c = gvjs_yl[b];
        c && (gvjs_p.clearTimeout(c.ac), delete gvjs_yl[b]);
        a.KU = 0;
    }
    a.qd && (a.qd.pW--, delete a.qd);
    b = a.ik;
    for (var d = (c = !1); a.$e.length && !a.iW; ) {
        ...
        if ((f = a.BI ? g : f))
            try {
                ...
                void 0 !== h &&
                    ((a.BI = a.BI && (h == b || a.Xk(h))), (a.ik = b = h));
                if (
                    gvjs_$k(b) ||
                    (typeof gvjs_p.Promise === gvjs_d &&
                        b instanceof gvjs_p.Promise)
                )
                    (d = !0), (a.iW = !0);
            } catch (k) {
                (b = k), (a.BI = !0), gvjs_xl(a) || (c = !0);
            }
    }
    a.ik = b;
    d &&
        ((h = gvjs_s(a.H8, a, !0)),
        (d = gvjs_s(a.H8, a, !1)),
        b instanceof gvjs_rl ? (gvjs_wl(b, h, d), (b.Oka = !0)) : b.then(h, d));
    c && ((b = new gvjs_zl(b)), (gvjs_yl[b.ac] = b), (a.KU = b.ac));
}
function gvjs_vl() {
    gvjs_ve.call(this);
}
...
function gvjs_Dl(a) {
    if (gvjs_r(a) && typeof a.$ === gvjs_d && typeof a.ca === gvjs_d) return a;
...
function gvjs_Gl(a, b, c, d) {
    var e;
    if ((e = b < a.$())) e = a.W(b) === c;
    if ((c = e)) (d = null == d ? null : d), (c = null == d || a.Jg(b) === d);
    return c;
}
...
gvjs_Cl.prototype.indexOf = function (a, b) {
    for (var c = 0; c < a.$(); c++) if (a.W(c) == b) return c;
    return -1;
};
function gvjs_Il(a, b, c) {
    for (var d = 0; d < b.length; ++d) {
        var e = b[d];
        if (e >= a.$() || a.W(e) != c[d]) return !1;
    }
    return !0;
}
function gvjs_Jl(a, b) {
    return gvjs_Gl(a, b, gvjs_g)
        ? gvjs_Kl(a, b, function (c) {
              return 0 <= c;
          })
        : !1;
}
...
function gvjs_rba(a) {
    ...
    return gvjs_Gl(a, 0, gvjs_g) && gvjs_Gl(a, 1, gvjs_g)
        ? gvjs_Kl(a, 0, function (c) {
...
gvjs_Ml.prototype.Pb = function (a) {
    ...
    if (2 > b) return !1;
    var c = a.W(0);
    if ((c != gvjs_Lb && c != gvjs_Mb) || a.W(1) != gvjs_g) return !1;
    c = 0;
    for (var d = 1; d < b; d++) {
        var e = a.W(d);
        if (e == gvjs_g) c = 0;
...
gvjs_Ml.prototype.Ej = function (a) {
    ...
    if (50 < c) a = !0;
        ...
        for (
            var e = Number.MAX_VALUE, f = Number.MIN_VALUE, g = 1;
            g < c;
            g++
        ) {
...
gvjs_Nl.prototype.Pb = function (a) {
    ...
    var b = 0,
        c = a.$();
    if (1 > c) return !1;
    if (!gvjs_Gl(a, 0, gvjs_g) && (b++, this.h7))
        for (; b < c && gvjs_Gl(a, b, gvjs_l); ) b++;
    for (var d = null; b < c; ) {
        var e = a.W(b);
        if (e == gvjs_g) d = {};
...
gvjs_Ol.prototype.Pb = function (a) {
    gvjs_Dl(a);
    if (!gvjs_Nl.prototype.Pb.call(this, a)) return !1;
    var b = a.$();
    if (this.W_)
        for (var c = 1; c < b; c++)
            if (gvjs_Gl(a, c, gvjs_g) && !gvjs_Jl(a, c)) return !1;
    return !0;
};
gvjs_Ol.prototype.Ej = function (a) {
    for (var b = a.$(), c = a.ca(), d = 0, e = !1, f = 0; f < b; f++)
        gvjs_Gl(a, f, gvjs_g) && (d++, gvjs_Jl(a, f) || (e = !0));
    return this.Pb(a)
        ? 1 == c || e || gvjs_Gl(a, 0, gvjs_l)
            ? 1
            : 2 < d && this.W_
            ? 3
            : 1 != d || this.W_
...
gvjs_Pl.prototype.Pb = function (a) {
    ...
    return 3 > b ||
        ...
        !gvjs_Gl(a, 1, gvjs_g) ||
        !gvjs_Gl(a, 2, gvjs_g) ||
        (3 < b && !gvjs_Gl(a, 3, gvjs_l)) ||
        (4 < b && !gvjs_Gl(a, 4, gvjs_g))
        ? !1
        : !0;
};
gvjs_Pl.prototype.Ej = function (a) {
    ...
    if (this.Pb(a)) {
        ...
        if (gvjs_Gl(b, 3, gvjs_l)) {
            for (
                var c = {}, d = 0, e = Math.min(b.ca(), 20), f = 0;
                f < e;
                f++
            ) {
...
gvjs_Ql.prototype.Pb = function (a) {
    ...
    for (var c = !0, d = 0; d < b; d++) {
        ...
        if (
            ...
            null != g &&
            null != h &&
            ((c = !1), e != Math.min(e, f, g, h) || h != Math.max(e, f, g, h))
        )
            return !1;
    }
    return !c;
...
gvjs_Tl.prototype.Ac = function (a, b, c) {
    try {
        ...
        if (gvjs_Il(a, [d, d + 1], [gvjs_g, gvjs_g])) {
            ...
            if (b === gvjs_yd)
                throw Error(
                    "displayMode must be set to Markers when using lat/long addresses."
                );
            b === gvjs_ub && (b = gvjs_bd);
        ...
        var m = null,
            n = null;
        gvjs_Il(a, [d], [gvjs_g]) &&
            ((m = d++), gvjs_Il(a, [d], [gvjs_g]) && (n = d++));
        var p = null;
        gvjs_Il(a, [d], [gvjs_l]) && gvjs_Pd == a.Bd(d, gvjs_Bd) && (p = d++);
        k != gvjs_xd && null != m && null == n && (n = m);
        if (a.$() != d)
            throw Error(
                "Table contains more columns than expected (Expecting " +
                    d +
                    " columns)"
            );
        return {
        ...
        return c && c.Sc("Incompatible data table: " + q), null;
    }
};
function gvjs_Ul(a) {
    gvjs_Nl.call(this, a);
...
gvjs_Yl.prototype.Pb = function (a) {
    a = gvjs_Dl(a);
    var b = a.$();
    if (3 > b || a.W(0) != gvjs_l) return !1;
    var c = a.W(1);
    if (
        (c != gvjs_g && c != gvjs_Lb && c != gvjs_l) ||
        (c == gvjs_l && !gvjs_sba(a) && !gvjs_tba(a)) ||
        (c == gvjs_g &&
            !gvjs_Kl(a, 1, function (e) {
                return gvjs_1g(e);
            }))
    )
        return !1;
...
function gvjs_sba(a) {
    return gvjs_Kl(a, 1, function (b) {
        return 7 != b.length ||
            isNaN(b.substring(0, 3)) ||
            "W" != b.charAt(4) ||
            isNaN(b.substring(6, 7))
            ? !1
            : !0;
    });
}
    ...
    if (this.Pb(a))
        if (1 == a.ca()) a = 1;
            ...
            if (!(b = !gvjs_Gl(a, 0, gvjs_l) || 25 < a.ca())) {
                for (var c = (b = 0); c < a.ca(); c++) b += a.getValue(c, 1);
                b = !((97 < b && 103 > b) || (0.97 < b && 1.03 > b));
            }
            a = b ? 2 : 3;
        }
    else a = 0;
...
gvjs_3l.prototype.Ac = function (a) {
    ...
    for (var b = [], c = a.$(), d = 0; d < c; ++d) {
        var e = a.Jg(d);
        if ("" === e) b.push({ index: d, Nf: {} });
        else {
            if (1 > b.length)
                throw Error(
                    "At least 1 data column must come before any role columns"
                );
            gvjs_Ae(b).Nf[e] = d;
        }
    }
    ...
    return 4 === c
        ? ((a = !gvjs_K(this.m, "timeline.taskMajor", !0)),
          { qw: b[a ? 1 : 0], tt: b[a ? 0 : 1], vL: b[2], WH: b[3] })
        : { qw: b[0], tt: null, vL: b[1], WH: b[2] };
};
gvjs_3l.prototype.jb = function (a, b, c) {
    Array.isArray(c) || (c = [c]);
    if (!gvjs_Hl(a, b, c)) throw Error(gvjs_Sa + b + gvjs_ba + c + "'.");
};
...
gvjs_6l.prototype.BW = function (a) {
    ...
    gvjs_u(this.yl, function (c) {
        var d = gvjs_wba[c],
            e = d && d.format;
        e && ((e = e.Ej(a)), 0 != e && b.push({ type: c, o$: e, ve: d.ve }));
    });
    gvjs_xba(b);
...
var gvjs_vba = {
    ...
    gvjs_wba = {
        AnnotatedTimeLine: { format: new gvjs_Ml(), ve: 3 },
        AreaChart: { format: new gvjs_Ol({ wB: !0 }), ve: 2 },
        BarChart: { format: new gvjs_Nl({ wB: !0 }), ve: 2 },
        BubbleChart: { format: new gvjs_Pl(), ve: 2 },
        CandlestickChart: { format: new gvjs_Ql(), ve: 2 },
        ColumnChart: { format: new gvjs_Nl({ wB: !0 }), ve: 2 },
        ComboChart: { format: new gvjs_Rl({ wB: !0 }), ve: 2 },
        Gauge: { format: new gvjs_Sl(), ve: 1 },
        GeoChart: { format: new gvjs_Tl(), ve: 3 },
        Histogram: { format: new gvjs_Ul(), ve: 3 },
        LineChart: { format: new gvjs_Nl({ wB: !0 }), ve: 2 },
        ImageRadarChart: { format: new gvjs_0l(), ve: 1 },
        ImageSparkLine: { format: new gvjs_1l(), ve: 1 },
        Map: { format: new gvjs_Vl(), ve: 2 },
        MotionChart: { format: new gvjs_Yl(), ve: 3 },
        OrgChart: { format: new gvjs_Zl(), ve: 2 },
        PieChart: { format: new gvjs__l(), ve: 2 },
        ScatterChart: { format: new gvjs_Nl({ wB: !0 }), ve: 2 },
        "AreaChart-stacked": { format: new gvjs_Ol({ Qh: !0 }), ve: 2 },
        SteppedAreaChart: { format: new gvjs_Ol(), ve: 2 },
        Table: { format: new gvjs_2l(), ve: 0 },
        Timeline: { format: new gvjs_3l(), ve: 2 },
        TreeMap: { format: new gvjs_5l(), ve: 2 },
        WordTree: { format: new gvjs_Tl(), ve: 2 },
    };
...
var gvjs_7l = {};
function gvjs_8l(a) {
    if (gvjs_y && !gvjs_Eg(9)) return [0, 0, 0, 0];
...
function gvjs_Eba(a, b, c) {
    ...
    if (0 == ("url(" < d ? -1 : "url(" == d ? 0 : 1)) {
        if (
            ...
            a = c
                ? (a = c(b, a)) && gvjs_xf(a) != gvjs_ob
                    ? 'url("' + gvjs_xf(a).replace(gvjs_Bba, gvjs_Dba) + '")'
                    : null
                : null;
        }
        return a;
    ...
    if (0 < b.indexOf("(")) {
        ...
        for (a = /([\-\w]+)\(/g; (c = a.exec(b)); )
            if (!(c[1].toLowerCase() in gvjs_Aba)) return null;
    }
    return b;
}
...
function gvjs_fm(a, b, c, d) {
    ...
    } else if (typeof b[c] != gvjs_d) throw Error(gvjs_va);
...
function gvjs_lm(a, b) {
    return (
        gvjs_fm(gvjs_Pba, a, a.getPropertyValue ? gvjs_Xb : gvjs_Vb, [b]) || ""
    );
}
...
var gvjs_Tba =
        gvjs_y && 10 > document.documentMode
            ? null
            : /\s*([^\s'",]+[^'",]*(('([^'\r\n\f\\]|\\[^])*')|("([^"\r\n\f\\]|\\[^])*")|[^'",])*)/g,
    gvjs_Uba = {
...
function gvjs_Vba(a, b, c) {
    ...
    gvjs_nm(gvjs_Le(a.cssRules)).forEach(function (e) {
        ...
        if (
            ...
            var f = b
                ? e.selectorText.replace(gvjs_Tba, "#" + b + " $1")
                : e.selectorText;
...
function gvjs_Xba(a) {
    ...
    c.sort(function (e, f) {
        ...
        a: {
            ...
            for (
                var g = gvjs_Re, h = Math.min(e.length, f.length), k = 0;
                k < h;
                k++
            ) {
                var l = g(e[k], f[k]);
    ...
    for (var d; (d = a.nextNode()); )
        c.forEach(function (e) {
            gvjs_fm(gvjs_Jba, d, d.matches ? "matches" : gvjs_nd, [
                e.selectorText,
            ]) &&
                e.style &&
                gvjs_Yba(d, e.style);
...
function gvjs_qm(a) {
    gvjs_ne(a) ? (a = gvjs_Le(a)) : ((a = gvjs_Ye(a)), gvjs_Ie(a, "cssText"));
    return a;
}
var gvjs_Zba = {
        "* ARIA-CHECKED": !0,
...
gvjs_rm.prototype.get = function (a) {
    if (gvjs_fm(gvjs_cm, a, gvjs_2c, [this.aC]))
        return (
            (a = parseInt(gvjs_fm(gvjs_dm, a, gvjs_Vb, [this.aC]) || null, 10)),
            this.mc[a]
        );
};
...
gvjs_tm.prototype.Qd = function (a) {
    if ("TEMPLATE" == gvjs_im(a).toUpperCase()) return null;
    var b = gvjs_im(a).toUpperCase();
    if (b in this.EL) b = null;
    else if (this.gF[b]) b = document.createElement(b);
    else {
        ...
        for (var e = 0, f; (f = d[e]); e++)
            if (f.specified) {
                ...
                if (gvjs_hf(k, gvjs_Kb)) h = null;
                    ...
                    g = gvjs_um(l, k);
                    g in this.sG
                        ? ((k = this.sG[g]), (h = k(h, m, n)))
                        : ((k = gvjs_um(null, k)),
                          k in this.sG
                              ? ((k = this.sG[k]), (h = k(h, m, n)))
                              : (h = null));
                }
...
gvjs_vm.prototype.sanitize = function (a) {
    ...
    if (gvjs_sm) {
        ...
        if (gvjs_sm) {
            ...
            this.D_ &&
                ((b = gvjs_pm("<div>" + b + gvjs_a)),
                gvjs_Xba(b),
                (b = b.innerHTML));
            b = gvjs_3f(b, null);
            var c = document.createElement("template");
            if (gvjs_2ba && "content" in c) gvjs_cg(c, b), (c = c.content);
            else {
            ...
            c.clear && c.clear();
        } else a = gvjs_dh(gvjs_6a);
        0 < gvjs_gm(a).length &&
            ((b = gvjs_dh(gvjs_6a)), b.appendChild(a), (a = b));
...
function gvjs_Nm(a, b) {
    if (b !== gvjs_Jm) throw Error("Bad secret");
    this.yea = a;
}
...
function gvjs_Pm(a) {
    if (a instanceof gvjs_Mm) {
        ...
        if (null === (b = gvjs_Km()) || void 0 === b || !b.isScript(a))
            if (a instanceof gvjs_Nm) a = a.yea;
...
function gvjs_Tm(a) {
    ...
    !a &&
        gvjs_p.self &&
        gvjs_p.self.location &&
        ((a = gvjs_p.self.location.protocol), (a = a.substr(0, a.length - 1)));
...
function gvjs_Um(a, b, c, d) {
    for (var e = c.length; 0 <= (b = a.indexOf(c, b)) && b < d; ) {
        ...
        if (38 == f || 63 == f)
            if (
                ((f = a.charCodeAt(b + e)), !f || 61 == f || 38 == f || 35 == f)
            )
                return b;
        b += e + 1;
    }
    ...
    if (a instanceof gvjs_Xm) {
        ...
        a && (c = String(a).match(gvjs_Qm))
            ? ((this.kn = !!b),
              ...
              gvjs_Zm(this),
              (this.Fy = gvjs_2m(a)))
            : ((this.kn = !!b), (this.cg = new gvjs_3m(null, this.kn)));
}
...
function gvjs_1m(a, b, c) {
    gvjs_Zm(a);
    b instanceof gvjs_3m
        ? ((a.cg = b), a.cg.O3(a.kn))
        : (c || (b = gvjs_4m(b, gvjs_mca)), (a.cg = new gvjs_3m(b, a.kn)));
    return a;
}
...
function gvjs_Zm(a) {
    if (a.nsa) throw Error("Tried to modify a read-only Uri");
}
gvjs_.O3 = function (a) {
    this.kn = a;
...
function gvjs_4m(a, b, c) {
    return typeof a === gvjs_l
        ? ((a = encodeURI(a).replace(b, gvjs_nca)),
...
gvjs_.cj = function () {
    gvjs_6m(this);
    for (
        var a = this.Hf.ob(), b = this.Hf.cj(), c = [], d = 0;
        d < b.length;
        d++
    )
...
gvjs_.clone = function () {
    var a = new gvjs_3m();
    a.Il = this.Il;
    this.Hf && ((a.Hf = this.Hf.clone()), (a.Vc = this.Vc));
    return a;
};
...
function gvjs_qca(a, b) {
    ...
    c.port1.onmessage = function (d) {
        var e = {};
        void 0 !== a.g5 && (clearTimeout(a.g5), (a.g5 = void 0));
        void 0 === d.data &&
            a.sv.reject("Callback called, but no data received");
        typeof d.data !== gvjs_l &&
            a.sv.reject("Exploitation attempt! Data is not a string!");
        try {
            e = JSON.parse(d.data);
        } catch (f) {
...
function gvjs_pca(a) {
    ...
    a = gvjs_$f(
        gvjs_yaa,
        gvjs_5f(gvjs_yb, {}, gvjs_waa(gvjs_laa(gvjs_Pm(a).toString())))
    );
    c.srcdoc = gvjs_1f(a);
...
function gvjs_9m(a) {
    null !== a.YI &&
        (document.documentElement.removeChild(a.YI), (a.YI = null));
}
function gvjs_$m(a) {
    switch (a) {
        case 200:
...
function gvjs_bn(a) {
    if (
        ...
        for (
            ...
            var d = b[c];
            try {
                return new ActiveXObject(d), (a.iba = d);
            } catch (e) {}
        }
        throw Error(
...
gvjs_.send = function (a, b, c, d) {
    ...
    this.kva &&
        "onprogress" in this.Zb &&
        ((this.Zb.onprogress = gvjs_s(function (f) {
            this.Jda(f, !0);
        }, this)),
        this.Zb.upload && (this.Zb.upload.onprogress = gvjs_s(this.Jda, this)));
    try {
        (this.u_ = !0), this.Zb.open(b, String(a), !0), (this.u_ = !1);
    } catch (f) {
        this.xy(5, f);
        return;
    }
    ...
    gvjs_Yd in this.Zb &&
        this.Zb.withCredentials !== this.e6 &&
        (this.Zb.withCredentials = this.e6);
    ...
    try {
        gvjs_ln(this),
            0 < this.wU &&
                ((this.Q5 = gvjs_wca(this.Zb))
                    ? ((this.Zb.timeout = this.wU),
                      (this.Zb.ontimeout = gvjs_s(this.zg, this)))
                    : (this.vU = gvjs_pl(this.zg, this.wU, this))),
            (this.lQ = !0),
            this.Zb.send(a),
            (this.lQ = !1);
    } catch (f) {
...
function gvjs_wca(a) {
    return (
        gvjs_y &&
        gvjs_Eg(9) &&
        typeof a.timeout === gvjs_g &&
        void 0 !== a.ontimeout
    );
}
gvjs_.zg = function () {
    "undefined" != typeof gvjs_ie &&
        this.Zb &&
        ((this.Az = "Timed out after " + this.wU + "ms, aborting"),
        this.dispatchEvent("timeout"),
        this.abort(8));
};
gvjs_.xy = function (a, b) {
    this.zu = !1;
    this.Zb && ((this.lz = !0), this.Zb.abort(), (this.lz = !1));
    this.Az = b;
    gvjs_mn(this);
    gvjs_nn(this);
};
function gvjs_mn(a) {
    a.yY || ((a.yY = !0), a.dispatchEvent(gvjs_Hb), a.dispatchEvent(gvjs_Rb));
}
...
gvjs_.M = function () {
    this.Zb &&
        (this.zu &&
            ((this.zu = !1), (this.lz = !0), this.Zb.abort(), (this.lz = !1)),
        gvjs_nn(this, !0));
...
function gvjs_on(a) {
    if (
        a.zu &&
        "undefined" != typeof gvjs_ie &&
        (!a.YU[1] || 4 != gvjs_pn(a) || 2 != a.getStatus())
    )
        if (a.lQ && 4 == gvjs_pn(a)) gvjs_pl(a.Kda, 0, a);
        else if ((a.dispatchEvent("readystatechange"), 4 == gvjs_pn(a))) {
            a.zu = !1;
            try {
                if (gvjs_qn(a))
                    a.dispatchEvent(gvjs_Hb), a.dispatchEvent("success");
                else {
                    try {
...
function gvjs_qn(a) {
    var b = a.getStatus(),
        c;
    if (!(c = gvjs_$m(b))) {
        if ((b = 0 === b)) (a = gvjs_Tm(String(a.m0))), (b = !gvjs_sca.test(a));
        c = b;
    }
    return c;
}
...
gvjs_.getResponseHeader = function (a) {
    if (this.Zb && 4 == gvjs_pn(this))
        return (a = this.Zb.getResponseHeader(a)), null === a ? void 0 : a;
};
gvjs_.getAllResponseHeaders = function () {
    return this.Zb && 4 == gvjs_pn(this)
        ? this.Zb.getAllResponseHeaders() || ""
        : "";
};
function gvjs_sn(a) {
...
function gvjs_xca(a) {
    ...
    function c() {
                ...
                if ('"' == t)
                    if (((r = e - 1), (t = b()), '"' == t)) r = null;
                        ...
                        throw new gvjs_tn(
                            a,
                            e - 1,
                            'Unexpected character "' + t + '" after quote mark'
                        );
                    }
            if (null === r)
                throw new gvjs_tn(
        ...
        for (;;) {
            ...
            if ('"' == t) throw new gvjs_tn(a, e - 1, "Unexpected quote mark");
            t = b();
        }
...
function gvjs_Cca(a, b, c) {
    ...
    this.WP = null != c ? c : !1;
    for (a = 0; a < b.length; a++)
        if (((c = b[a]), !gvjs_un[c])) throw Error("Unsupported type: " + c);
    this.types = b;
}
var gvjs_un = {
    number: function (a) {
...
function gvjs_Bn(a) {
    ...
    f =
        (a = new RegExp(gvjs_An.source + gvjs_Dca.source + gvjs_vn.source).test(
            f
        )) || g.test(f);
    return (b && a) || ((d || e || c) && f);
}
...
var gvjs_Dn = {
    ...
    gvjs_vca = new gvjs_aj({ "X-DataSource-Auth": "a" });
...
function gvjs_Fn(a, b) {
    ...
    if (0 < a.length) {
        b += "?";
        g = [];
        for (d = 0; d < a.length; d++) g.push(a[d].W1);
        b += g.join("&");
    }
    return b;
}
...
function gvjs_In(a, b, c, d) {
    a.VC({
        version: "0.6",
        status: gvjs_Rb,
        errors: [{ reason: b, message: c, detailed_message: d }],
    });
}
gvjs_.IV = function (a) {
    var b = {};
    ...
    this.HK &&
        ((a = new gvjs_Xm(a)),
        gvjs_tg && (gvjs_Zm(a), a.Ld("zx", gvjs_hg())),
        (a = a.toString()));
    return a;
};
gvjs_.nr = function () {
    ...
    e === gvjs_ub && ((d = gvjs_Oca(b)), (e = d.sendMethod), (d = d.options));
    if (e === gvjs_ad)
        if (gvjs_je("gadgets.io.makeRequest")) gvjs_Pca(this, b, this.tca);
        else throw Error("gadgets.io.makeRequest is not defined.");
    else if (
        "xhr" === e ||
        (e === gvjs_ub && gvjs_Qca(c.Vj().location.href, b))
    )
        (c = void 0),
            (e = b),
            "POST" === f &&
                        ...
                        if (a.Zda) {
                            ...
                            if (g && 0 < g.length) {
                                ...
                                for (p = m.length; n < p; n++)
                                    (q = m[n]), k.xd(q.type || gvjs_l, q.label);
                                l.columns = m;
                                m = l.columns;
                                n = l = l.WP ? 1 : 0;
                            ...
                            k.match(/^({.*})$/)
                                ? gvjs_Gn(gvjs_Li(k))
                                : gvjs_te(k);
                    } else if (a.Hw) gvjs_In(a, gvjs_Kc, gvjs_sn(g));
                    else
                        throw Error(
                            "google.visualization.Query: " + gvjs_sn(g)
                        );
                },
                f,
                c,
                this.fza || !!d.xhrWithCredentials
            );
    else {
        if (this.Zda)
            throw Error(
                "CSV files on other domains are not supported. Please use sendMethod: 'xhr' or 'auto' and serve your .csv file from the same domain as this page."
            );
...
function gvjs_Oca(a) {
    var b = {};
    if (/[?&]alt=gviz(&[^&]*)*$/.test(a)) a = gvjs_Dn.Hia;
    else {
        var c = (gvjs_Wm(a, "tqrt") || gvjs_Dn.YF).split(":");
        a = c[0];
        ("xhr" !== a && "xhrpost" !== a) ||
            !gvjs_He(c, gvjs_Yd) ||
            (b.xhrWithCredentials = !0);
        gvjs__e(gvjs_Dn, a) || (a = gvjs_Dn.YF);
    }
    return { sendMethod: a, options: b };
}
function gvjs_Qca(a, b) {
...
function gvjs_Pca(a, b, c) {
    ...
    null == c[d.RequestParameters.CONTENT_TYPE] &&
        (c[d.RequestParameters.CONTENT_TYPE] = d.ContentType.TEXT);
    null == c[d.RequestParameters.AUTHORIZATION] &&
        (c[d.RequestParameters.AUTHORIZATION] = d.AuthorizationType.SIGNED);
    null == c.OAUTH_ENABLE_PRIVATE_NETWORK &&
        (c.OAUTH_ENABLE_PRIVATE_NETWORK = !0);
...
gvjs_.sqa = function (a) {
    if (null != a && a.data) gvjs_te(a.data);
    else {
        var b = "";
...
function gvjs_Tca(a) {
    gvjs_fn(a).then(
        function (b) {
            try {
                (b = b.replace(
                    /^[\s\S]*google\.visualization\.Query\.setResponse\(/g,
                    ""
                )),
                    (b = b.replace(/\);?[\s]*$/g, "")),
                    gvjs_Gn(gvjs_Li(b));
...
function gvjs_Ln(a) {
    a.xU && (clearTimeout(a.xU), (a.xU = null));
}
function gvjs_Kn(a) {
    gvjs_Ln(a);
...
function gvjs_Mn(a) {
    a.IK && (clearTimeout(a.IK), (a.IK = null));
}
function gvjs_Sca(a) {
    gvjs_Mn(a);
...
gvjs_.Fwa = function (a) {
    if (typeof a !== gvjs_zb) throw Error("Refreshable must be a boolean");
    return (this.Eea = a);
};
gvjs_.Jn = function (a) {
    if (typeof a !== gvjs_l) throw Error("queryString must be a string");
    this.query = a;
};
...
function gvjs_On(a, b) {
    ...
    (typeof c !== gvjs_zb || c) &&
        gvjs_jf(gvjs_gg(a.format)) &&
        ((b = gvjs_De(b, function (d) {
            return !gvjs_jf(gvjs_gg(d));
        })),
        gvjs_Pe(b),
        1 == b.length && ((b = gvjs_Uca(b[0])), (a.format = b)));
}
function gvjs_Uca(a) {
    gvjs_jf(gvjs_gg(a)) ||
        ((a = a.replace(/\d/g, "0")),
    ...
    if (b) {
        ...
        if (d)
            if (c == gvjs_ra)
                ...
                c == gvjs_qa ? gvjs_On(e, h) : (gvjs_On(f, h), gvjs_On(g, k));
                0 < l &&
                    b.W(0) != gvjs_l &&
                    ((c = c == gvjs_qa ? f : e),
                    (m = b.Co(0)),
...
function gvjs_Zca(a) {
    var b = a.mb(),
        c = a.Ni;
    if (Array.isArray(c))
        for (var d = 0; d < c.length; d++) b = gvjs_Rk(b, c[d]);
    else null != c && (b = gvjs_Rk(b, c));
    a.RE(null);
    a.zh(b);
}
function gvjs__ca(a) {
...
gvjs_.ah = gvjs_n(24);
gvjs_.Jb = function () {
    this.Fu && ((this.Fu.vQ = !0), (this.Fu = null));
    this.Lh && this.Lh.promise && (this.Lh.promise.cancel(), (this.Lh = null));
    this.He();
};
gvjs_.He = function () {};
gvjs_.M = function () {
...
function gvjs_Sn(a, b) {
    ...
    typeof a === gvjs_d
        ? (this.rp(""), (this.Kr = a))
        : typeof a === gvjs_l && "" !== a
        ? (this.rp(a), (this.Kr = null))
        : null == a && (this.rp(a), (this.Kr = null));
    a = b.packages;
...
gvjs_.Owa = function (a) {
    ...
    gvjs_u([gvjs_i, gvjs_k, gvjs_Rb, gvjs_Hd], function (e) {
        var f = gvjs_oi(a, e, function () {
            e == gvjs_i && ((c.zD = null), (c.visualization = a));
            (e != gvjs_i && e != gvjs_Hd) ||
                typeof a.getState !== gvjs_d ||
                c.setState(a.getState.call(a));
            gvjs_I(c, e, b[0]);
        });
        d.push(f);
    });
...
function gvjs_Un(a) {
    a.visualization &&
        typeof a.visualization.Jb === gvjs_d &&
        a.visualization.Jb();
    gvjs_Wn(a);
...
gvjs_.yh = function (a) {
    a != this.cf && (gvjs_Tn(this), (this.cf = a));
};
gvjs_.mb = function () {
    return this.Z;
};
...
gvjs_.nva = function (a) {
    Array.isArray(this.Ni)
        ? this.Ni.push(a)
        : (this.Ni = null === this.Ni ? [a] : [this.Ni, a]);
};
gvjs_.getQuery = function () {
    return this.Dw;
};
...
gvjs_.ba = function (a, b) {
    if (null == b) {
        if (((b = this.m), null !== gvjs_Xn(b, a))) {
            var c = a.split(".");
            1 < c.length && ((a = c.pop()), (b = gvjs_Xn(b, c.join("."))));
            delete b[a];
        }
    } else gvjs_Yn(this.m, a, b);
};
function gvjs_Yn(a, b, c) {
    ...
    for (var d = 0; d < b.length; d++) {
        ...
        d == b.length - 1
            ? (a[e] = c)
            : ((gvjs_r(a[e]) && a[e] !== Object.prototype[e]) || (a[e] = {}),
              (a = a[e]));
    }
}
...
gvjs_.lna = function (a, b) {
    if (b.Xk()) {
        var c = b.sP(),
            d = b.nZ();
        a = gvjs_Xk(a, b);
        gvjs_I(this, gvjs_Rb, { id: a, message: c, detailedMessage: d });
    } else this.EO(a, b.mb());
};
gvjs_.EO = function (a, b) {
    ...
    if (!d)
        throw Error(
            "Invalid " +
                this.sM +
                " type: " +
                (c || String(this.Kr) || "unknown")
        );
    this.Kr = d;
    this.MR &&
        (gvjs_Un(this), (this.visualization = this.MR), (this.MR = null));
    if ((c = this.visualization && this.visualization.constructor == d))
        c =
            (c = this.visualization) && typeof c.getContainer === gvjs_d
                ? c.getContainer() == a
                : !1;
    c ? (a = this.visualization) : (gvjs_Un(this), (a = new d(a)));
    ...
    for (d = 0; d < this.e$.length; d++) this.e$[d](b);
...
gvjs_.UZ = function (a, b) {
    ...
    a = gvjs_0ca(a, b);
    gvjs_I(this, gvjs_Rb, { id: a, message: b });
};
gvjs_.setProperty = function (a, b) {
    ...
    if (0 < a.length) {
        ...
        if ((c = gvjs_1ca[c]))
            0 === a.length
                ? c.set.apply(this, b)
                : ((c = c.get.apply(this)), gvjs_Yn(c, a.join("."), b));
    }
};
var gvjs_1ca = {
    name: { get: gvjs_Sn.prototype.getName, set: gvjs_Sn.prototype.rr },
    type: { get: gvjs_Sn.prototype.getType, set: gvjs_Sn.prototype.rp },
    container: {
        get: gvjs_Sn.prototype.getContainer,
        set: gvjs_Sn.prototype.yfa,
    },
    containerId: { get: gvjs_Sn.prototype.jP, set: gvjs_Sn.prototype.mT },
    options: { get: gvjs_Sn.prototype.Zc, set: gvjs_Sn.prototype.setOptions },
    state: { get: gvjs_Sn.prototype.getState, set: gvjs_Sn.prototype.setState },
    dataSourceUrl: { get: gvjs_Sn.prototype.kP, set: gvjs_Sn.prototype.yh },
    dataTable: { get: gvjs_Sn.prototype.mb, set: gvjs_Sn.prototype.zh },
    refreshInterval: { get: gvjs_Sn.prototype.xP, set: gvjs_Sn.prototype.np },
    query: { get: gvjs_Sn.prototype.getQuery, set: gvjs_Sn.prototype.Jn },
    view: { get: gvjs_Sn.prototype.EP, set: gvjs_Sn.prototype.RE },
};
function gvjs_Zn() {
    this.mh = new gvjs_aj();
    this.$s = new gvjs_aj();
...
function gvjs_3n(a, b) {
    ...
    b = [];
    c = gvjs_8d(c);
    for (var d = c.next(); !d.done; d = c.next()) b.push(a.mh.get(d.value));
    return b;
}
gvjs_.getChildren = function (a) {
    ...
    a = [];
    b = gvjs_8d(b);
    for (var c = b.next(); !c.done; c = b.next()) a.push(this.mh.get(c.value));
    return a;
};
function gvjs_4n(a) {
    if (a.mh.isEmpty()) return [];
    var b = [];
    gvjs_gj(
        a.$s,
        function (c, d) {
        ...
        for (var e = [], f = 0; f < d.length; f++) {
            ...
            if (h) {
                ...
                for (var k = h.next(); !k.done; k = h.next())
                    (k = k.value),
                        b.get(k).delete(g),
                        0 === b.get(k).size && (b.remove(k), e.push(k));
            }
        }
        d = e;
    }
    if (c.length != a.mh.Cd()) throw Error("cycle detected");
}
gvjs_.clone = function () {
    return this.isEmpty()
        ? new gvjs_Zn()
        : gvjs_Zn.prototype.WO.apply(this, gvjs_4n(this));
};
gvjs_.WO = function (a) {
    var b = new gvjs_Zn();
    if (0 == arguments.length) return b;
    for (var c = 0; c < arguments.length; c++) gvjs_5n(this, arguments[c], b);
    return b;
};
function gvjs_5n(a, b, c) {
    ...
    if (d) {
        ...
        for (var e = d.next(); !e.done; e = d.next())
            (e = e.value), gvjs__n(c, b, e), gvjs_5n(a, e, c);
    }
}
function gvjs_1n(a) {
    var b = typeof a;
...
function gvjs_8n(a, b) {
    return new Set(
        [].concat(gvjs_9d(a)).filter(function (c) {
            return !b.has(c);
        })
    );
}
function gvjs_9n(a, b) {
    return (
        a.size === b.size &&
        [].concat(gvjs_9d(a)).every(function (c) {
            return b.has(c);
        })
    );
}
...
gvjs_.equals = function (a) {
    return (
        gvjs_9n(this.pj, a.pj) &&
        gvjs_9n(this.dl, a.dl) &&
        gvjs_9n(this.nk, a.nk)
    );
};
...
function gvjs_co(a) {
    return gvjs_nj(a.nk).map(function (b) {
        b = b.split(",");
        return { row: Number(b[0]), column: Number(b[1]) };
    });
}
...
gvjs_.add = function (a, b) {
    ...
    a === gvjs_Cd
        ? this.pj.add(String(b[0]))
        : a === gvjs_Fb
        ? this.dl.add(String(b[0]))
        : this.nk.add(String(b[0] + "," + b[1]));
    return !0;
};
gvjs_.Kp = function (a) {
...
gvjs_.qE = function (a) {
    if (!gvjs_do(this, a)) return !1;
    this.pj.delete(String(a));
    return !0;
};
gvjs_.BS = function (a) {
    if (!gvjs_eo(this, a)) return !1;
...
gvjs_.setSelection = function (a) {
    ...
    for (var e = 0; e < a.length; e++) {
        var f = a[e];
        null != f.row && null != f.column
            ? d.add("" + f.row + "," + f.column)
            : null != f.row
            ? b.add(String(f.row))
            : null != f.column && c.add(String(f.column));
    }
...
gvjs_.bind = function (a, b) {
    if (gvjs_io(a) && typeof a.Oy === gvjs_d)
        if (gvjs_io(b)) {
            var c = gvjs_pe(a);
            if (gvjs_pe(b) == c) this.Sd.Sc("Cannot bind a control to itself.");
            else {
                c = [];
                this.ph.contains(a) || c.push(a);
                this.ph.contains(b) || c.push(b);
                gvjs__n(this.ph, a, b);
                if (this.ph.DQ()) var d = !0;
                else
                    this.Sd.Sc(
                        "The requested control and participant cannot be bound together, as this would introduce a dependency cycle"
                    ),
                        (d = !1);
                if (d)
                    for (a = 0; a < c.length; a++)
                        (b = c[a]),
                            this.wD.push(
                                gvjs_oi(b, gvjs_Hd, gvjs_s(this.Iqa, this, b))
                            ),
                            this.wD.push(
                                gvjs_oi(b, gvjs_i, gvjs_s(this.Gqa, this, b))
                            ),
                            this.wD.push(
                                gvjs_oi(b, gvjs_Rb, gvjs_s(this.Fqa, this, b))
                            ),
                            b.getChart &&
                                this.wD.push(
                                    gvjs_oi(
            ...
            this.Sd.Sc(
                b +
                    " does not fit either the Control or Visualization specification."
            );
    else this.Sd.Sc(a + " does not fit the Control specification.");
};
gvjs_.draw = function (a) {
    if (a && !this.ph.isEmpty()) {
        ...
        a = gvjs_4n(this.ph);
        for (var b = 0; b < a.length; b++) a[b].zh(this.ZI);
        this.Tm.start(a);
    }
};
function gvjs_io(a) {
    return (
        gvjs_r(a) &&
        typeof a.draw === gvjs_d &&
        typeof a.setDataTable === gvjs_d
    );
}
...
gvjs_.Gqa = function (a) {
    ...
    if ((b = gvjs_io(a) && typeof a.Oy === gvjs_d)) {
        ...
        if (gvjs_r(b))
            if (typeof b.i7 === gvjs_d)
                a: {
                    ...
                    for (
                        ...
                        if (
                            f != a &&
                            gvjs_3n(c, f).length != gvjs_3n(b, f).length
                        ) {
                            b = !1;
                            break a;
                        }
            ...
            else b = typeof b.apply === gvjs_d ? !0 : !1;
        else b = !1;
        b = !b;
    }
    b
        ? this.Sd.Sc(
              a +
                  " does not fit the Control specification while handling 'ready' event."
          )
        : ((this.Tm = this.Tm || new gvjs_jo(this)), gvjs_ko(this.Tm, a));
};
...
gvjs_.Hqa = function (a) {
                ...
                for (var f = a.mb(); f !== this.ZI; ) {
                    e = {
                        ...
                        column:
                            null == e.column
                                ? null
                                : f.getTableColumnIndex(e.column),
                    };
                    0 > e.row && (e.row = null);
    ...
    gvjs_u(
        ...
        function (e) {
            ...
            this.RB[f]
                ? (this.RB[f].delete(b),
                  0 === this.RB[f].size && gvjs_lo(this, e))
                : gvjs_lo(this, e);
        },
        this
    );
...
function gvjs_5ca(a, b) {
    b
        ...
        : a.Sd.Sc("One or more participants failed to draw()");
    a.Tm = null;
}
function gvjs_6ca(a, b) {
    ...
    for (
        b = 1;
        b < d.length &&
        ((e = gvjs_oj(e, new Set(gvjs_mo(a, d[b])))), 0 !== e.size);
        b++
    );
    b = [];
    for (var f = 0; f < c.ca(); f++) e.has(gvjs_no(a, c, f)) && b.push(f);
    e = new Set(gvjs_oo(a, d[0]));
    for (
        f = 1;
        f < d.length &&
        ((e = gvjs_oj(e, new Set(gvjs_oo(a, d[f])))), 0 !== e.size);
        f++
    );
    d = [];
    for (f = 0; f < c.$(); f++) e.has(gvjs_po(a, c, f)) && d.push(f);
    a = new gvjs_N(c);
    a.pp(b);
    a.Hn(d);
    return a;
...
function gvjs_po(a, b, c) {
    for (; b !== a.ZI && -1 !== c; ) (c = b.CP(c)), (b = b.mb());
    -1 == c && (c = null);
    return c;
}
function gvjs_jo(a) {
    ...
    this.zr = {};
    a = this.ph.ob();
    for (var b = 0; b < a.length; b++) this.zr[gvjs_pe(a[b])] = gvjs_i;
}
gvjs_jo.prototype.start = function (a) {
    gvjs_jo.prototype.yca.apply(this, a);
    for (var b = 0; b < a.length; b++) this.Mj(a[b]);
};
...
gvjs_jo.prototype.yca = function (a) {
    for (
        var b = gvjs_Zn.prototype.WO.apply(this.ph, arguments),
            c = b.ob(),
            d = 0;
        d < c.length;
        d++
...
gvjs_jo.prototype.Mj = function (a) {
    ...
    var b = (0, gvjs_D.uX)(
        ...
        gvjs_s(this.handleError, this, a)
    );
    gvjs_pl(b);
};
function gvjs_qo(a, b) {
    ...
    if (c) {
        ...
        for (b = 0; b < c.length; b++) {
            ...
            e && ((e = gvjs_7ca(a, d)), d.zh(e), a.Mj(d));
        }
    }
}
function gvjs_7ca(a, b) {
    b = gvjs_v(gvjs_3n(a.ph, b), function (c) {
        c = c.Oy();
        if (typeof c.apply === gvjs_d) return c.apply.call(c);
    });
...
gvjs_.bind = function (a, b) {
    ...
    Array.isArray(b) || (b = [b]);
    for (var c = 0; c < a.length; c++)
        for (var d = 0; d < b.length; d++) this.Xp.bind(a[c], b[d]);
    return this;
};
gvjs_.draw = function (a) {
    this.Xp.draw(a);
...
gvjs_.VC = function (a) {
    ...
    b(a) &&
        this.visualization &&
        ((this.Ta = a.mb()), this.visualization.draw(this.Ta, this.options));
};
gvjs_.oT = function (a) {
    if (null == a) this.BX = null;
    else {
        if (typeof a !== gvjs_d) throw Error(gvjs_Aa);
        this.BX = a;
    }
};
gvjs_.nT = function (a) {
...
function gvjs_vo(a) {
    ...
    return a.dashboardType
        ? new (gvjs_je(gvjs_hc))(a)
        : a.controlType
        ? new gvjs_P(a)
        : new gvjs_Q(a);
}
...
function gvjs_yo(a, b, c) {
    ...
    (gvjs_Ao(b) && gvjs_Ao(c)) ||
        ((a.se = gvjs_v(b, a.A1, a)), (a.nN = gvjs_v(c, a.Vta, a)));
}
gvjs_.A1 = function (a) {
...
gvjs_.Vta = function (a) {
    var b = a.controls,
        c = a.participants;
    if (gvjs_Ao(b) || gvjs_Ao(c)) throw Error("invalid binding: " + a);
...
gvjs_.k$ = function (a) {
    ...
    if (gvjs_r(a) || (typeof a === gvjs_l && c.test(a)))
        return (
            gvjs_zo(b) || (b = gvjs_vo(b)), this.se.push(b), this.se.length - 1
        );
    a = gvjs_9ca(this);
...
gvjs_Co.prototype.format = function (a, b) {
    ...
    if (null != this.Jo(c)) {
        ...
        d >= e && ((f = f || a.Sj(b)), (e = f.max), (d = f.min));
        ...
        null == k && (k = !0);
        for (
            var l = Math.round(((g - d) / f) * h), m = h - l, n = 0;
            n < a.ca();
            n++
        ) {
            ...
            0 < l
                ? p < g
                    ...
                    : (gvjs_Do("w", l, q),
                      ...
                      gvjs_Do(t, r - l, q),
                      gvjs_Do("w", h - r, q))
                : (gvjs_Do(t, r, q), gvjs_Do("w", h - r, q));
            gvjs_Do("s", 1, q);
            p = a.getProperty(n, b, gvjs_nb);
            null == p && ((p = a.Ha(n, b)), a.setProperty(n, b, gvjs_nb, p));
            k && (q.push("\u00a0"), q.push(p));
            q.push("</span>\u00a0");
            a.Nw(n, b, q.join(""));
        }
...
var gvjs_$ca = { red: "r", blue: "b", green: "g" };
...
function gvjs_Ho(a, b, c, d, e) {
    ...
    typeof a === gvjs_g &&
        typeof b === gvjs_g &&
        ((this.sS = b - a), 0 >= this.sS && (this.sS = 1));
...
gvjs_q(
    "google.visualization.createUrl",
    function (a, b) {
        typeof a === gvjs_l && (a = gvjs_Li(a));
        var c = [],
            d;
...
gvjs_q(
    "google.visualization.createSnippet",
    function (a) {
...
function gvjs_No(a, b, c) {
    ...
    c = void 0 === c ? [] : c;
    for (
        var e = [], f = [], g = gvjs_8d(b), h = g.next();
        !h.done;
        h = g.next()
    )
        if (((h = h.value), typeof h === gvjs_g)) e.push(h);
    ...
    var p = a.bn(g),
        q = [];
    for (g = 0; g < c.length; g++) q.push([]);
    for (
        g = { Sr: 0 };
        g.Sr < p.length;
        g = { BM: g.BM, Sr: g.Sr, gV: g.gV }, g.Sr++
    ) {
        for (h = 0; h < c.length; h++)
            q[h].push(a.getValue(p[g.Sr], a.jf(c[h].column)));
        h = !1;
        if (g.Sr < p.length - 1)
            for (h = !0, k = 0; k < e.length; k++)
                if (
                    ((l = a.getValue(p[g.Sr], e[k])),
...
gvjs_q(
    ...
    function (a, b, c, d, e, f) {
        ...
        f = f.map(b.jf.bind(b));
        for (
            var g = c === gvjs_$c || c === gvjs_Tb,
                h = c === gvjs_j || c === gvjs_Tb,
                k = new gvjs_M(),
                l = d.map(function (B) {
                    var D = a.W(B[0]),
                        C = b.W(B[1]);
                    if (D !== C)
                        throw Error(
                            "Key types do not match:" + D + gvjs_ha + C
                        );
                    gvjs_Oo(k, a, B[0]);
                    return D;
                }),
        ...
        n = b.bn(n);
        p = gvjs_8d(e);
        for (q = p.next(); !q.done; q = p.next()) gvjs_Oo(k, a, q.value);
        p = gvjs_8d(f);
        for (q = p.next(); !q.done; q = p.next()) gvjs_Oo(k, b, q.value);
        p = !1;
            ...
            if (p && 0 !== v) (p = !1), t++;
                ...
                if ((-1 === v && g) || (1 === v && h) || 0 === v) {
                    ...
                    for (q = A.next(); !q.done; q = A.next())
                        (q = q.value),
                            c === gvjs_Tb
                                ? k.Wa(u, x, y.getValue(w[z], q[z]))
                                : k.Wb(
                                      u,
                                      x,
                                      y.getValue(w[z], q[z]),
                                      y.Ha(w[z], q[z]),
                                      y.getProperties(w[z], q[z])
                                  ),
                            x++;
                    if ((-1 === v && g) || 0 === v)
                        for (
                            y = d.length, x = 0, z = gvjs_8d(e), q = z.next();
                            !q.done;
                            q = z.next()
                        )
                            (q = q.value),
...
function gvjs_Po(a, b) {
    gvjs_Ai.call(this);
    if (a instanceof gvjs_Ai) this.bd = a;
    else if (null == a) this.bd = new gvjs_M();
    else {
        this.data = a;
        a: {
            if (
                b &&
                ((a = b ? gvjs_kj(b, this.data) : this.data), Array.isArray(a))
            ) {
                b = a[0];
                a = Array.isArray(b)
                    ? gvjs_Mk(a)
...
gvjs_q(
    "google.visualization.NumberFormat.useNativeCharactersIfAvailable",
    function (a) {
        gvjs_lk = a;
    },
    void 0
