...
function gvjs_hq(a, b, c) {
    ...
    for (var e = (d = 0); e < b; e++)
        e === a.AJ.length && a.AJ.push(0), (d += a.AJ[e]);
    a.AJ[b]++;
    gvjs_fq(a.Gd, c, d);
}
function gvjs_iq(a, b) {
    for (var c = gvjs_8d(Object.keys(b)), d = c.next(); !d.done; d = c.next()) {
        d = d.value;
        var e = b[d];
        null != e && e instanceof Object && !Array.isArray(e)
            ? ((a[d] = a[d] || {}), gvjs_iq(a[d], e))
            : null != e && (a[d] = e);
    }
}
function gvjs_jq(a) {
...
var gvjs_gda = (function () {
    ...
    return gvjs_ug
        ? ((a = /1[0|1][_.][0-9_.]+/),
          (a = a.exec(gvjs_Rf)) ? a[0].replace(/_/g, ".") : "10")
        : gvjs_Eaa
        ? ((a = /Android\s+([^\);]+)(\)|;)/), (a = a.exec(gvjs_Rf)) ? a[1] : "")
        : gvjs_Faa || gvjs_Gaa || gvjs_Haa
...
var gvjs_oq = (function () {
    if (gvjs_Laa) return gvjs_nq(/Firefox\/([0-9.]+)/);
    if (gvjs_y || gvjs_rg || gvjs_qg) return gvjs_Dg;
    if (gvjs_Kg)
        return gvjs_mg()
            ? gvjs_nq(/CriOS\/([0-9.]+)/)
            : gvjs_nq(/Chrome\/([0-9.]+)/);
    if (gvjs_Lg && !gvjs_mg()) return gvjs_nq(/Version\/([0-9.]+)/);
    if (gvjs_Ig || gvjs_Jg) {
        var a = /Version\/(\S+).*Mobile\/(\S+)/.exec(gvjs_Rf);
        if (a) return a[1] + "." + a[2];
    } else if (gvjs_Maa)
        return (a = gvjs_nq(/Android\s+([0-9.]+)/))
            ? a
            : gvjs_nq(/Version\/([0-9.]+)/);
    return "";
})();
...
var gvjs_tq = {
    s: function (a, b, c) {
        return isNaN(c) || "" == c || a.length >= Number(c)
            ...
            : (a =
                  -1 < b.indexOf("-", 0)
                      ? a + gvjs_eg(" ", Number(c) - a.length)
                      : gvjs_eg(" ", Number(c) - a.length) + a);
    },
...
gvjs_uq.prototype.fireEvent = function (a, b) {
    ...
    for (d = 0; d < e; d++) c[d].apply(this, b);
    return 0 < e;
};
function gvjs_vq(a, b) {
    if (!a.cI.hasOwnProperty(b)) throw 'event type "' + b + '" unknown.';
}
function gvjs_wq(a) {
    this.cI = {
        add: [],
    ...
    this.Zn = [];
    this.lS = [];
    if (null != a) for (var b in a) this.setStyle(b, a[b]);
    this.f6 = null;
}
gvjs_t(gvjs_wq, gvjs_uq);
gvjs_ = gvjs_wq.prototype;
gvjs_.data = function (a) {
    return void 0 !== a ? ((this.ra = a), this) : this.ra;
};
...
gvjs_.style = function (a, b) {
    return void 0 !== b
        ? (this.setStyle(a, b) && this.fireEvent(gvjs_Rp, [this, a]), this)
        : this.getStyle(a);
};
gvjs_.styles = function (a) {
    for (var b in a) a.hasOwnProperty(b) && this.style(b, a[b]);
    return this;
};
...
gvjs_.kEa = function () {
    for (var a = this; 0 < this.Zn.length; ) {
        ...
        b.o(gvjs_up, function (c, d) {
            c = a.lS.indexOf(d);
            if (0 > c) throw "Animation not found.";
            a.lS.splice(c, 1);
...
var gvjs_hda =
    gvjs_p.requestAnimationFrame ||
    gvjs_p.mozRequestAnimationFrame ||
    gvjs_p.webkitRequestAnimationFrame ||
    gvjs_p.msRequestAnimationFrame ||
    function (a) {
...
function gvjs_zq(a, b, c, d) {
    ...
    if (f && g) {
        ...
        var k = ["clip", h, e, f, g].join(),
            l = c.yr;
        if ((c = a.g3(k, l))) n = c.getAttribute(gvjs_5c);
        else {
            var m = gvjs_Ph();
...
function gvjs_Hq(a, b, c, d, e) {
    ...
    if (h && k) {
        ...
        var q = c.yr;
        if ((c = a.g3(f, q))) g = c.getAttribute(gvjs_5c);
        else {
            var r = gvjs_Ph();
    ...
    } else e && e.substr(0, 5) === gvjs_dq && b.removeAttribute(g);
}
function gvjs_Gq(a, b, c, d) {
    ...
    if (f || g) {
        var h =
                e.kt("shadow.xOffset") ||
                e.kt("shadow.x-offset") ||
                e.kt(gvjs_Xp) ||
                0,
            k =
                e.kt("shadow.yOffset") ||
                e.kt("shadow.y-offset") ||
                e.kt(gvjs_Yp) ||
                0;
        e = [gvjs_Yo, f, g, h, k].join();
        var l = c.yr,
            m = a.g3(e, l);
        if (m) c = m.getAttribute(gvjs_5c);
        else {
            var n = gvjs_Ph();
            ...
            m.appendChild(p);
            m.appendChild(f);
            null != r && (q.appendChild(r), m.appendChild(q));
            g.appendChild(h);
            g.appendChild(n);
            m.appendChild(g);
            a.N4(e, m, l);
    ...
    } else b.hasAttribute(gvjs_tp) && b.removeAttribute(gvjs_tp);
}
var gvjs_ida = {
    "fill.color": gvjs_Bq,
    fillColor: gvjs_Bq,
...
function gvjs_Iq(a, b, c, d, e, f) {
    f = f || {};
    return (c = f[c] || gvjs_ida[c]) ? (c(a, b, d, e), !0) : !1;
}
var gvjs_Jq = {
...
gvjs_Jq.DK = { r: gvjs_Jq.j7, x: gvjs_Jq.applyX, y: gvjs_Jq.applyY };
...
var gvjs_Pq = { x: gvjs_Lq, y: gvjs_Mq, rx: gvjs_Nq, ry: gvjs_Oq };
gvjs_Kq.kCa = gvjs_Nq;
gvjs_Kq.lCa = gvjs_Oq;
...
gvjs_Kq.Lf = function (a, b, c, d, e) {
    if (!gvjs_Iq(a, e, c, b, d, gvjs_Pq)) throw gvjs_cq + c + '".';
};
var gvjs_Qq = {
    k7: function (a, b, c) {
...
gvjs_Qq.DK = { x1: gvjs_Qq.k7, x2: gvjs_Qq.l7, y1: gvjs_Qq.m7, y2: gvjs_Qq.n7 };
...
gvjs_Qq.Lf = function (a, b, c, d, e) {
    if (!gvjs_Iq(a, e, c, b, d, gvjs_Qq.DK)) throw gvjs_cq + c + '".';
};
function gvjs_Rq(a) {
    a %= 360;
...
function gvjs_Tq(a) {
    ...
    for (var b = [], c = 0, d = a.length; c < d; c++) {
        ...
        if ("GVIZARC" === e[0]) {
            ...
            f = !!Number(f[7]);
            270 === l && 0 === m
                ? (e = "A " + e + " " + k + gvjs_Qo + (e + g) + " " + h)
                : 180 === l && 270 === m
                ? (e = "A " + e + " " + k + gvjs_Qo + g + " " + (h - k))
                : 0 === l && 90 === m
                ? (e = "A " + e + " " + k + gvjs_Qo + g + " " + (h + k))
                : 90 === l && 180 === m
                ? (e = "A " + e + " " + k + gvjs_Qo + (g - e) + " " + h)
                : ((g += Math.cos((m / 180) * Math.PI) * e),
...
function gvjs_Uq(a) {
    gvjs_wq.call(this, a);
    this.eo = { x1: null, y1: null, x2: null, y2: null, width: 0, height: 0 };
    this.$u = [];
}
...
function gvjs_Wq(a) {
    ...
    k + c > m && ((q = m / (k + c)), (k *= q), (l *= q), (c *= q), (d *= q));
    f + l > n && ((q = n / (f + l)), (e *= q), (f *= q), (k *= q), (l *= q));
    h + d > n && ((q = n / (h + d)), (g *= q), (h *= q), (c *= q), (d *= q));
    return new gvjs_Uq(a.md)
        .move(p + m - g, b)
        .arc(p + m - g, b + h, g, h, 270, 0, !0)
        .line(p + m, b + n - d)
        .arc(p + m - c, b + n - d, c, d, 0, 90, !0)
        .line(p + k, b + n)
        .arc(p + k, b + n - l, k, l, 90, 180, !0)
        .line(p, b + f)
        .arc(p + e, b + f, e, f, 180, 270, !0)
        .close();
}
var gvjs_Xq = {
    draw: function (a, b, c, d) {
        ...
        if ((typeof e === gvjs_g && typeof f === gvjs_g) || !gvjs_Vq(b)) {
            ...
            gvjs_zq(a, d, b, c);
        } else (b = gvjs_Wq(b)), (d = gvjs_Sq(a, c, b, d));
        c && d.parentNode !== c && c.appendChild(d);
        return d;
    },
                ...
                case gvjs_9o:
                    ...
                    g === gvjs_Lp
                        ? ((a = gvjs_Wq(b)),
                          ...
                          e.setAttribute("d", a))
                        : c === gvjs_$o
                        ? e.setAttribute("rx", gvjs_L(gvjs_xq(b), gvjs_$o))
                        : c === gvjs_ap &&
                          e.setAttribute("ry", gvjs_L(gvjs_xq(b), gvjs_ap));
                    break;
                default:
...
function gvjs__q(a, b, c) {
    ...
    b.style.fontSize =
        typeof a === gvjs_g ? a + gvjs_T : typeof a === gvjs_l ? a : "";
}
function gvjs_0q(a, b, c) {
    a = c.style("font.weight") || c.style("fontWeight");
    b.style.fontWeight =
        typeof a === gvjs_l || typeof a === gvjs_g ? String(a) : "";
}
function gvjs_1q(a, b, c) {
    !0 === c.style(gvjs_Gp)
        ? (b.style.fontStyle = gvjs_Gp)
        : (b.style.fontStyle = "");
}
function gvjs_2q(a, b, c) {
    !0 === c.style(gvjs_bq)
        ? (b.style.textDecoration = gvjs_bq)
...
function gvjs_4q(a, b, c, d, e, f, g, h) {
    ...
    e.setAttribute(
        gvjs_Jd,
        "cursor:default;-webkit-user-select:none;-moz-osx-font-smoothing:grayscale;"
    );
...
function gvjs_5q(a, b, c, d) {
    ...
    h && (a.setAttribute("dir", gvjs_Up), a.setAttribute(gvjs_$p, gvjs_R));
    return { group: a, lines: l ? c : [a] };
}
function gvjs_6q(a, b, c, d) {
    ...
    if (typeof e === gvjs_g) {
        if (((e = Math.max(0, Math.min(1, e))), isNaN(e) || !isFinite(e)))
            e = 0;
    } else e = gvjs_Xo;
    var f = c.getBBox(),
        g = b.style("y") - f.y;
    var h =
        "tspan" === a[a.length - 1].tagName.toLowerCase()
            ? a[a.length - 1].getBoundingClientRect().top -
              c.getBoundingClientRect().top
            : a[a.length - 1].getBBox().y - f.y;
    var k = b.style("y");
    if (null == k) return c;
    if (typeof e === gvjs_g) k = k + g - f.height * e;
    else if (e === gvjs_Xo) k = k + g - h;
    else throw "Unrecognized valign value: " + e;
    c.setAttribute("y", k);
    e = 0;
...
gvjs_Yq.Lf = function (a, b, c, d, e) {
    ...
    if (f || !gvjs_Iq(a, e, c, b, d, gvjs_3q))
        if (c === gvjs_m || c === gvjs_Dp || c === gvjs_eq || f) {
            ...
            a = gvjs_6q(a, b, d, e);
            if (e !== a) throw "error redrawing text";
        } else
            throw (
                'error redrawing text element with changed property "' +
                c +
                '".'
            );
};
...
var gvjs_jda = {
    ...
    Path: {
        ...
        Lf: function (a, b, c, d, e) {
            if (!gvjs_Iq(a, e, c, b, d)) throw gvjs_cq + c + '".';
        },
    },
    Rect: gvjs_Xq,
    Text: gvjs_Yq,
...
function gvjs_9q(a, b, c, d, e) {
    ...
    a = Math.round(a);
    d = Math.min(d, a + c);
    return { before: a, after: d, size: d - a };
}
