                    ...
                    <div class="ec-vendor-upload-detail">
                        <form class="row g-3" method="POST" action="{{ route('supplier.store') }}"
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="selected_category" id="Categories"
                                    class="form-select {{ $errors->has('selected_category') ? 'is-invalid' : '' }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="vendor_phone" name="vendor_phone" value="{{ old('vendor_phone') }}"
                                    class="form-control {{ $errors->has('vendor_phone') ? 'is-invalid' : '' }}">
                                @error('vendor_phone')
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="email" name="vendor_email" value="{{ old('vendor_email') }}"
                                    class="form-control {{ $errors->has('vendor_email') ? 'is-invalid' : '' }}">
                                @error('vendor_email')
                            ...
                            <div class="col-md-12">
                                ...
                                <input id="vendor_address" name="vendor_address" value="{{ old('vendor_address') }}"
                                    class="form-control {{ $errors->has('vendor_address') ? 'is-invalid' : '' }}">
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea name="vendor_description" id="description"
                                    class="form-control {{ $errors->has('vendor_description') ? 'is-invalid' : '' }}" rows="2">{{ old('vendor_description') }}</textarea>
