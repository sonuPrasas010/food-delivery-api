            ...
            <div class="ec-cat-form">
                ...
                <form method="POST" action="/category" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-12">
                            <textarea id="sortdescription" cols="40" rows="2" class="form-control " name="short_desc"> {{ old('short_desc') }} </textarea>

                        </div>
                    </div>
                    <div class="form-group row"><label class="col-12 col-form-label">Full Description</label>
                        <div class="col-12">
                            <textarea id="fulldescription" name="description" cols="40" rows="4" class="form-control">{{ old('description') }}</textarea>
                        </div>
                    </div>
